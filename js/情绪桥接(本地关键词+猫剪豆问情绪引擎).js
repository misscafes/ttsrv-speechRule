    ...
    try {
        ...
        function normalizeEmotionDebugValue(raw) {
            ...
            var map = {
                ...
                "温柔": "tender",
                "抱怨": "angry", "埋怨": "angry", "牢骚": "angry",
                "发牢骚": "angry", "不满": "angry", "嘟囔": "angry",
                "恐惧": "fear", "厌恶": "hate", "沮丧": "depressed",
                "安慰": "comfort", "广告": "advertising",
        ...
        function inferStrongLocalEmotion(text) {
            ...
            // VV大军强愤怒检测（优先匹配）
            if (/(暴喝|暴怒|怒喝|怒吼|咆哮|嘶吼|厉喝|狂吼|吼道|喝骂|破口大骂|勃然大怒|怒不可遏|气炸|杀了你|去死|滚开|闭嘴|住口|混账|混蛋|畜生|找死)/.test(compact) || /！！|!!/.test(s)) return "愤怒";
        ...
        for (var i = dialogs.length - 1; i >= 0; i--) {
            ...
            if (emotion && ENABLE_EMOTION_BRIDGE === 1) {
                ...
                if (prefix) {
                    ...
                    java.log("[情绪桥接] " + emotion + " -> " + prefix + " | " + d.content.substring(0, 30));
                }
            }
        }
        return result;
