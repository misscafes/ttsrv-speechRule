...
**日期**: 2026-06-16
**当前版本**: 猫剪豆问引擎 **v1.3** / 猫剪豆问脚本 **v1.7**
**目录结构规范**:
- `new/猫剪豆问（优化版）v1.3.json`（引擎，最新）
- `new/(脚本)猫剪豆问（优化版）v1.7.json`（脚本，含情绪桥接）
- `new/猫剪豆问（优化版）v1.2_旁白情绪不依赖emo备份.json`（引擎 v1.2 备份）
- `new/(脚本)猫剪豆问（优化版）v1.5_旁白默认情绪+配套引擎v1.3备份.json`（脚本 v1.5 备份）
- `new/(脚本)猫剪豆问（优化版）v1.6_发音人数量与自然排序备份.json`（脚本 v1.6 备份）
