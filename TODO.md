...
- **保留文件**：
  ...
  - `new/猫剪豆问（优化版）v1.3.json`（最新引擎）
  - `js/new/(脚本)猫剪豆问（优化版）v1.7_obj{0,1,2}.js`（最新脚本调阅）
  - `js/new/猫剪豆问（优化版）v1.3.js`（最新引擎调阅）
- **归档位置**：
...
**日期**: 2026-06-16
**当前版本**: 猫剪豆问引擎 **v1.4** / 猫剪豆问脚本 **v1.7**
**目录结构规范**:
- `new/猫剪豆问（优化版）v1.4.json`（引擎，最新）
- `new/(脚本)猫剪豆问（优化版）v1.7.json`（脚本，含情绪桥接）
- `js/new/猫剪豆问（优化版）v1.4.js`（引擎调阅）
- `js/new/(脚本)猫剪豆问（优化版）v1.7_obj{0,1,2}.js`（脚本调阅）
- `历史版本/猫剪豆问/`：v1.1 ~ v1.6 全部历史 JSON 及备份
- `js/历史版本/猫剪豆问/`：对应历史版本的 JS 调阅文件
