...
.method public static decode([BII)[B
    ...
    :cond_1
    :goto_0
    iget v3, v0, Ls8/b;->i:I

    if-gt v3, p1, :cond_4

    .line 10
    invoke-static {p0, v0, p1}, Lcn/hutool/core/codec/Base64Decoder;->getNextValidDecodeByte([BLs8/b;I)B
...
.method private static getNextValidDecodeByte([BLs8/b;I)B
    .locals 3

    .line 1
    :cond_0
    iget v0, p1, Ls8/b;->i:I
