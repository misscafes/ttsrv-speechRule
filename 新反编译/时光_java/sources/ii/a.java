...
public abstract class a {
    ...
    public static d f(d dVar) {
        return (((((double) Math.round(dVar.f13759a)) > 90.0d ? 1 : (((double) Math.round(dVar.f13759a)) == 90.0d ? 0 : -1)) >= 0 && (((double) Math.round(dVar.f13759a)) > 111.0d ? 1 : (((double) Math.round(dVar.f13759a)) == 111.0d ? 0 : -1)) <= 0) && ((((double) Math.round(dVar.f13760b)) > 16.0d ? 1 : (((double) Math.round(dVar.f13760b)) == 16.0d ? 0 : -1)) > 0) && (((double) Math.round(dVar.f13761c)) < 65.0d)) ? d.a(dVar.f13759a, dVar.f13760b, 70.0d) : dVar;
    }

    public static double g(double[] dArr) {
        double[] dArrP = p(dArr, f13742e);
        double dC = c(dArrP[0]);
        double dC2 = c(dArrP[1]);
        double dC3 = c(dArrP[2]);
    ...
    public static double[] k(int i10) {
        double dO = o((i10 >> 16) & 255);
        double dO2 = o((i10 >> 8) & 255);
        double dO3 = o(i10 & 255);
        double[][] dArr = f13739b;
        double[] dArr2 = dArr[0];
        double d11 = (dArr2[2] * dO3) + (dArr2[1] * dO2) + (dArr2[0] * dO);
        double[] dArr3 = dArr[1];
        double d12 = (dArr3[2] * dO3) + (dArr3[1] * dO2) + (dArr3[0] * dO);
        double[] dArr4 = dArr[2];
        double d13 = (dArr4[2] * dO3) + (dArr4[1] * dO2) + (dArr4[0] * dO);
        double[] dArr5 = f13741d;
        double d14 = d11 / dArr5[0];
        double d15 = d12 / dArr5[1];
        double d16 = d13 / dArr5[2];
        double dJ = j(d14);
        double dJ2 = j(d15);
        return new double[]{(116.0d * dJ2) - 16.0d, (dJ - dJ2) * 500.0d, (dJ2 - j(d16)) * 200.0d};
    }
    ...
    public static double n(double d11, double d12) {
        ...
        double dV = v(d11);
        double d13 = ((dV + 5.0d) * d12) - 5.0d;
        if (d13 < 0.0d || d13 > 100.0d) {
            return -1.0d;
        }
        double dS = s(d13, dV);
        double dAbs = Math.abs(dS - d12);
        if (dS < d12 && dAbs > 0.04d) {
            return -1.0d;
        }
        double dJ = ((j(d13 / 100.0d) * 116.0d) - 16.0d) + 0.4d;
        if (dJ < 0.0d || dJ > 100.0d) {
            return -1.0d;
        }
        return dJ;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0300 A[LOOP:6: B:29:0x01b6->B:75:0x0300, LOOP_END] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.util.LinkedHashMap q(int[] r29) {
        /*
            Method dump skipped, instruction units count: 1702
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ii.a.q(int[]):java.util.LinkedHashMap");
    }

    public static double r(double d11, double d12) {
        return s(v(d11), v(d12));
    }
    ...
    public static ArrayList t(LinkedHashMap linkedHashMap) {
        ArrayList arrayList = new ArrayList();
        int[] iArr = new int[360];
        double d11 = 0.0d;
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            d dVar = new d(((Integer) entry.getKey()).intValue());
            arrayList.add(dVar);
            int iFloor = (int) Math.floor(dVar.f13759a);
            int iIntValue = ((Integer) entry.getValue()).intValue();
            iArr[iFloor] = iArr[iFloor] + iIntValue;
            d11 += (double) iIntValue;
        }
        ...
        while (i14 < size) {
            ...
            i14++;
            d dVar2 = (d) obj;
            int iRound = ((int) Math.round(dVar2.f13759a)) % 360;
            if (iRound < 0) {
                iRound += 360;
            }
            double d13 = dArr[iRound];
            double d14 = dVar2.f13760b;
            if (d14 >= 5.0d && d13 > 0.01d) {
                arrayList2.add(new m(dVar2, ((d14 - 48.0d) * (d14 < 48.0d ? 0.1d : 0.3d)) + (d13 * 100.0d * 0.7d)));
            }
        }
        Collections.sort(arrayList2, new w(5));
        ...
        for (int i15 = 90; i15 >= 15; i15--) {
            ...
            while (i16 < size2) {
                ...
                while (true) {
                    ...
                    i17++;
                    if (180.0d - Math.abs(Math.abs(dVar3.f13759a - ((d) obj3).f13759a) - 180.0d) < i15) {
                        break;
                    }
                }
        ...
        while (i10 < size4) {
            ...
            i10++;
            arrayList4.add(Integer.valueOf(((d) obj4).f13762d));
        }
        return arrayList4;
    }
    ...
    public static double v(double d11) {
        return l((d11 + 16.0d) / 116.0d) * 100.0d;
    }
}
