...
public class Range {
    ...
    public static Range of(Node node, boolean z11) {
        String str = z11 ? RangeKey : EndRangeKey;
    ...
    public void track(Node node, boolean z11) {
        node.attributes().putUserData(z11 ? RangeKey : EndRangeKey, this);
    }
}
