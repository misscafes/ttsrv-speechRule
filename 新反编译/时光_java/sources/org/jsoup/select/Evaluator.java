...
public abstract class Evaluator {
    ...
    public static final class AttributeWithValue extends AttributeKeyPair {
        ...
        public String toString() {
            return v.c("[", this.key, "=", this.value, "]");
        }
    }
    ...
    public static final class AttributeWithValueMatching extends Evaluator {
        ...
        public String toString() {
            return v.c("[", this.key, "~=", this.pattern.toString(), "]");
        }
    }
    ...
    public static final class ContainsData extends Evaluator {
        ...
        public String toString() {
            return a.l(":containsData(", this.searchText, ")");
        }
    }
    ...
    public static final class ContainsOwnText extends Evaluator {
        ...
        public String toString() {
            return a.l(":containsOwn(", this.searchText, ")");
        }
    }
    ...
    public static final class ContainsText extends Evaluator {
        ...
        public String toString() {
            return a.l(":contains(", this.searchText, ")");
        }
    }
    ...
    public static final class ContainsWholeOwnText extends Evaluator {
        ...
        public String toString() {
            return a.l(":containsWholeOwnText(", this.searchText, ")");
        }
    }
    ...
    public static final class ContainsWholeText extends Evaluator {
        ...
        public String toString() {
            return a.l(":containsWholeText(", this.searchText, ")");
        }
    }
    ...
    public static final class Id extends Evaluator {
        ...
        @Override // org.jsoup.select.Evaluator
        public boolean matches(Element element, Element element2) {
            return this.f22168id.equals(element2.id());
        }

        public String toString() {
            return k.B("#", this.f22168id);
        }
    }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        protected final int f22166a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        protected final int f22167b;
        ...
        public String toString() {
            return this.f22166a == 0 ? String.format(":%s(%d)", getPseudoClass(), Integer.valueOf(this.f22167b)) : this.f22167b == 0 ? String.format(":%s(%dn)", getPseudoClass(), Integer.valueOf(this.f22166a)) : String.format(":%s(%dn%+d)", getPseudoClass(), Integer.valueOf(this.f22166a), Integer.valueOf(this.f22167b));
        }
    ...
    public static abstract class AttributeKeyPair extends Evaluator {
        ...
        public AttributeKeyPair(String str, String str2, boolean z11) {
            Validate.notEmpty(str);
            Validate.notEmpty(str2);
            this.key = Normalizer.normalize(str);
            boolean z12 = (str2.startsWith("'") && str2.endsWith("'")) || (str2.startsWith("\"") && str2.endsWith("\""));
            str2 = z12 ? k.i(1, 1, str2) : str2;
            this.value = z11 ? Normalizer.normalize(str2) : Normalizer.normalize(str2, z12);
        }
