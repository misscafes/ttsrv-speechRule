...
final class Tokeniser {
    ...
    static final int[] win1252Extensions = {8364, org.mozilla.javascript.Token.SWITCH, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 352, 8249, 338, org.mozilla.javascript.Token.VOID, 381, org.mozilla.javascript.Token.EMPTY, org.mozilla.javascript.Token.COMPUTED_PROPERTY, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 353, 8250, 339, org.mozilla.javascript.Token.LOCAL_BLOCK, 382, 376};
    ...
    public int[] consumeCharacterReference(Character ch2, boolean z11) {
        int iIntValue;
        ...
        if (z11 && (this.reader.matchesLetter() || this.reader.matchesDigit() || this.reader.matchesAny('=', '-', '_'))) {
            this.reader.rewindToMark();
            return null;
        }
        this.reader.unmark();
    ...
    public Token.Tag createTagPending(boolean z11) {
        Token.Tag tagReset = z11 ? this.startPending.reset() : this.endPending.reset();
    ...
    public String unescapeEntities(boolean z11) {
        StringBuilder sbBorrowBuilder = StringUtil.borrowBuilder();
        while (!this.reader.isEmpty()) {
            sbBorrowBuilder.append(this.reader.consumeTo('&'));
            if (this.reader.matches('&')) {
                this.reader.consume();
                int[] iArrConsumeCharacterReference = consumeCharacterReference(null, z11);
    ...
    public void emit(char c11) {
        if (this.charsString == null) {
            this.charsString = String.valueOf(c11);
        } else {
            if (this.charsBuilder.length() == 0) {
                this.charsBuilder.append(this.charsString);
            }
            this.charsBuilder.append(c11);
        }
        this.charPending.startPos(this.charStartPos);
        this.charPending.endPos(this.reader.pos());
    }
