...
public abstract class TreeBuilder {
    ...
    private void trackNodePosition(Node node, Token token, boolean z11) {
        int iStartPos;
        ...
        new Range(position, new Range.Position(iEndPos, this.reader.lineNumber(iEndPos), this.reader.columnNumber(iEndPos))).track(node, z11);
    }
