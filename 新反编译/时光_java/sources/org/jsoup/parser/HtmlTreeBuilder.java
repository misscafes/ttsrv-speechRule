...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    private static boolean onStack(ArrayList<Element> arrayList, Element element) {
        ...
        int i10 = size - 1;
        int i11 = i10 >= maxQueueDepth ? size - 257 : 0;
        while (i10 >= i11) {
    ...
    private void replaceInQueue(ArrayList<Element> arrayList, Element element, Element element2) {
        ...
        Validate.isTrue(iLastIndexOf != -1 ? true : $assertionsDisabled);
    ...
    public HtmlTreeBuilderState currentTemplateMode() {
        if (this.tmplInsertMode.size() > 0) {
            return (HtmlTreeBuilderState) k.f(1, this.tmplInsertMode);
        }
        return null;
    }
    ...
    public void framesetOk(boolean z11) {
        this.framesetOk = z11;
    }

    public void generateImpliedEndTags(boolean z11) {
        String[] strArr = z11 ? TagThoroughSearchEndTags : TagSearchEndTags;
    ...
    public FormElement insertForm(Token.StartTag startTag, boolean z11, boolean z12) {
        dedupeAttributes(startTag);
    ...
    public Element lastFormattingElement() {
        if (this.formattingElements.size() > 0) {
            return (Element) k.f(1, this.formattingElements);
        }
        return null;
    }
    ...
    public void reconstructFormattingElements() {
        ...
        if (this.stack.size() > maxQueueDepth || (elementLastFormattingElement = lastFormattingElement()) == null || onStack(elementLastFormattingElement)) {
            return;
        }
        int size = this.formattingElements.size();
        int i10 = size - 12;
    ...
    */
    ...
    public void setFosterInserts(boolean z11) {
