...
public class ContextFactory {
    ...
    private static final boolean useThreadSafeObjectsByDefault = RhinoConfig.get("rhino.useThreadSafeObjectsByDefault", false);
    ...
    public final void initApplicationClassLoader(ClassLoader classLoader) {
        ...
        if (!Kit.testIfCanLoadRhinoClasses(classLoader)) {
            ...
            ge.c.C("applicationClassLoader can only be set once");
        } else {
            checkNotSealed();
    ...
    public Object doTopCall(Script script, Context context, Scriptable scriptable, Scriptable scriptable2) {
        Object objExec = script.exec(context, scriptable, scriptable2);
        return objExec instanceof ConsString ? objExec.toString() : objExec;
    }
