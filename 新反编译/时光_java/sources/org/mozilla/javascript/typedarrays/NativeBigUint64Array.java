...
public class NativeBigUint64Array extends NativeBigIntArrayView {
    ...
    public NativeBigUint64Array(int i10) {
    ...
    public static Object init(Context context, Scriptable scriptable, boolean z11) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 3, 2, new g(11));
        lambdaConstructor.setPrototypePropertyAttributes(7);
        NativeTypedArrayView.init(context, scriptable, lambdaConstructor, new b1(13));
    ...
    public static /* synthetic */ Scriptable lambda$init$8434bfc6$1(Context context, Scriptable scriptable, Object[] objArr) {
        return NativeTypedArrayView.js_constructor(context, scriptable, objArr, new b1(14), 8);
    }
    ...
    public Object js_get(int i10) {
        ...
        long uint64Primitive = ByteIo.readUint64Primitive(this.arrayBuffer.buffer, (i10 * 8) + this.offset, NativeArrayBufferView.useLittleEndian());
        if ((Long.MIN_VALUE & uint64Primitive) == 0) {
            return BigInteger.valueOf(uint64Primitive);
        }
        return BigInteger.valueOf(uint64Primitive >> 32).shiftLeft(32).add(BigInteger.valueOf(uint64Primitive));
    }
    ...
    public NativeBigUint64Array(NativeArrayBuffer nativeArrayBuffer, int i10, int i11) {
