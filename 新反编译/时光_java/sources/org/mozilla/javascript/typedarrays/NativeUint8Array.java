...
public class NativeUint8Array extends NativeTypedArrayView<Integer> {
    ...
    public static Object init(Context context, Scriptable scriptable, boolean z11) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 3, 2, new g(21));
    ...
    public static /* synthetic */ Scriptable lambda$init$8434bfc6$1(Context context, Scriptable scriptable, Object[] objArr) {
        return NativeTypedArrayView.js_constructor(context, scriptable, objArr, new b1(29), 1);
    }
    ...
    public Object js_set(int i10, Object obj) {
        ...
        ByteIo.writeUint8(this.arrayBuffer.buffer, i10 + this.offset, uint8);
        return null;
    }
