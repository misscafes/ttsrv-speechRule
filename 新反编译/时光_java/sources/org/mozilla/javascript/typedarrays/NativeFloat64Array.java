...
public class NativeFloat64Array extends NativeTypedArrayView<Double> {
    ...
    public static Object init(Context context, Scriptable scriptable, boolean z11) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 3, 2, new g(14));
        lambdaConstructor.setPrototypePropertyAttributes(7);
        NativeTypedArrayView.init(context, scriptable, lambdaConstructor, new b1(18));
    ...
    public static /* synthetic */ Scriptable lambda$init$8434bfc6$1(Context context, Scriptable scriptable, Object[] objArr) {
        return NativeTypedArrayView.js_constructor(context, scriptable, objArr, new b1(17), 8);
    }
    ...
    public Object js_set(int i10, Object obj) {
        ...
        ByteIo.writeUint64(this.arrayBuffer.buffer, (i10 * 8) + this.offset, Double.doubleToLongBits(number), NativeArrayBufferView.useLittleEndian());
        return null;
    }

    @Override // java.util.List
    public Double set(int i10, Double d11) {
        ensureIndex(i10);
        return (Double) js_set(i10, d11);
    }
