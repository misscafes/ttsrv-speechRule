...
public class NativeInt8Array extends NativeTypedArrayView<Byte> {
    ...
    public static Object init(Context context, Scriptable scriptable, boolean z11) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 3, 2, new g(17));
        lambdaConstructor.setPrototypePropertyAttributes(7);
        NativeTypedArrayView.init(context, scriptable, lambdaConstructor, new b1(24));
    ...
    public static /* synthetic */ Scriptable lambda$init$8434bfc6$1(Context context, Scriptable scriptable, Object[] objArr) {
        return NativeTypedArrayView.js_constructor(context, scriptable, objArr, new b1(23), 1);
    }
    ...
    public Object js_set(int i10, Object obj) {
        ...
        ByteIo.writeInt8(this.arrayBuffer.buffer, i10 + this.offset, int8);
        return null;
    }

    @Override // java.util.List
    public Byte set(int i10, Byte b11) {
        ensureIndex(i10);
        return (Byte) js_set(i10, b11);
    }
