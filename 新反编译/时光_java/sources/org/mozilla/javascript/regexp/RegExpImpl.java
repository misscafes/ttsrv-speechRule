...
public class RegExpImpl implements RegExpProxy {
    ...
    private static NativeRegExp createRegExp(Context context, Scriptable scriptable, Object[] objArr, int i10, boolean z11) {
        Object obj;
        String string;
        Scriptable topLevelScope = ScriptableObject.getTopLevelScope(scriptable);
        if (objArr.length == 0 || (obj = objArr[0]) == Undefined.instance) {
            return NativeRegExpInstantiator.withLanguageVersionScopeCompiled(context.getLanguageVersion(), topLevelScope, NativeRegExp.compileRE(context, vd.d.EMPTY, vd.d.EMPTY, false));
        }
        ...
        return NativeRegExpInstantiator.withLanguageVersionScopeCompiled(context.getLanguageVersion(), topLevelScope, NativeRegExp.compileRE(context, string2, string, z11));
    }
    ...
    */
    ...
    private static Object matchOrReplace(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr, RegExpImpl regExpImpl, GlobData globData, NativeRegExp nativeRegExp) {
        ...
        globData2.global = z11;
        int[] iArr = {0};
        int i10 = globData2.mode;
        if (i10 == 4) {
            if (Boolean.TRUE.equals(nativeRegExp.executeRegExp(context, scriptable, regExpImpl, str, iArr, 0))) {
        ...
        while (iArr[0] <= str.length()) {
            Object objExecuteRegExp = nativeRegExp2.executeRegExp(context, scriptable, regExpImpl, str, iArr, 0);
            String str2 = str;
            int[] iArr2 = iArr;
            if (Boolean.TRUE.equals(objExecuteRegExp)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:100:0x011a A[SYNTHETIC] */
    ...
    */
    ...
    @Override // org.mozilla.javascript.RegExpProxy
    public void register(ScriptableObject scriptableObject, boolean z11) {
        NativeRegExpStringIterator.init(scriptableObject, z11);
        new LazilyLoadedCtor(scriptableObject, "RegExp", z11, true, (Initializable) new v(20));
    }
