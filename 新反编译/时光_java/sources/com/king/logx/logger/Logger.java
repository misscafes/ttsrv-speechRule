...
public abstract class Logger implements ILogger {
    ...
    private final /* synthetic */ String getTag() {
        ...
        StackTraceElement stackTraceElement = (StackTraceElement) n.M0(stackTrace, getStackOffset(stackTrace) + this.lastOffset);
    ...
    public /* synthetic */ Logger(LogFormat logFormat, int i10, int i11, f fVar) {
    ...
    public Logger(LogFormat logFormat, int i10) {
        ...
        builder.m20setLogFormat(logFormat);
        builder.m21setMethodOffset(i10);
        this(builder.build());
    }
}
