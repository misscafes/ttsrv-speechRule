...
public class NavigationRailMenuView extends NavigationBarMenuView {
    ...
    public final int b(int i10, int i11, int i12, View view) {
        ...
        return (Math.max(0, i14 - 1) * this.U0) + measuredHeight;
    }
    ...
    public final void onLayout(boolean z11, int i10, int i11, int i12, int i13) {
        ...
        int iMax = i15 <= 1 ? 0 : Math.max(0, Math.min((getMeasuredHeight() - measuredHeight) / (i15 - 1), this.U0));
        int i17 = 0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (currentVisibleContentItemCount <= 1 || ((labelVisibilityMode = getLabelVisibilityMode()) != -1 ? labelVisibilityMode != 0 : currentVisibleContentItemCount <= 3)) {
            iB = b(i10, size, currentVisibleContentItemCount, null);
        } else {
            ...
            iB = b(i10, size, currentVisibleContentItemCount, childAt) + measuredHeight;
        }
        setMeasuredDimension(View.MeasureSpec.getSize(i10), View.resolveSizeAndState(iB, i11, 0));
    }
