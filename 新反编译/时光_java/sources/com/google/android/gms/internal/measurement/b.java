    ...
    */
    public static boolean a(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.b.a(byte[], int, int):boolean");
    }
    ...
    public static /* synthetic */ int d(byte[] bArr, int i10, int i11) {
        ...
        return (b14 << UnicodeProperties.NONSPACING_MARK) ^ ((b13 << 8) ^ b11);
    }
}
