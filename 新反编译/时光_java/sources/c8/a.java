...
public final class a implements Interpolator {
    ...
    public final float getInterpolation(float f7) {
        ...
        float[] fArr = this.f3926a;
        int iMin = Math.min((int) ((fArr.length - 1) * f7), fArr.length - 2);
        float f11 = this.f3927b;
        float f12 = (f7 - (iMin * f11)) / f11;
        float f13 = fArr[iMin];
        return b.a.b(fArr[iMin + 1], f13, f12, f13);
    }

    public a(float[] fArr) {
        this.f3926a = fArr;
        this.f3927b = 1.0f / (fArr.length - 1);
    }
}
