...
public abstract class a {
    ...
    public static final AtomicReference f33590a = new AtomicReference();
    ...
    public static ByteBuffer b(InputStream inputStream) throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(ArchiveEntry.AE_IFDIR);
        AtomicReference atomicReference = f33590a;
        byte[] bArr = (byte[]) atomicReference.getAndSet(null);
        if (bArr == null) {
            bArr = new byte[ArchiveEntry.AE_IFDIR];
        }
        while (true) {
