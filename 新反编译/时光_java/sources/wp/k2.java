...
public final class k2 extends qx.i implements yx.p {
    public final /* synthetic */ String X;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final /* synthetic */ String f32398i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k2(String str, String str2, ox.c cVar) {
        super(2, cVar);
        this.f32398i = str;
        this.X = str2;
    }
    ...
    public final ox.c create(Object obj, ox.c cVar) {
        return new k2(this.f32398i, this.X, cVar);
    }

    @Override // yx.p
    public final Object invoke(Object obj, Object obj2) {
        k2 k2Var = (k2) create((ry.z) obj, (ox.c) obj2);
        jx.w wVar = jx.w.f15819a;
        k2Var.invokeSuspend(wVar);
        return wVar;
    }
