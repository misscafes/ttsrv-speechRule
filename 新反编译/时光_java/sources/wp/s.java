...
public final class s extends qx.i implements yx.p {
    ...
    public final /* synthetic */ Set f32449i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s(Set<String> set, y yVar, ox.c cVar) {
        super(2, cVar);
        this.f32449i = set;
        this.X = yVar;
    }
    ...
    public final ox.c create(Object obj, ox.c cVar) {
        return new s(this.f32449i, this.X, cVar);
    }

    @Override // yx.p
    public final Object invoke(Object obj, Object obj2) {
        return ((s) create((ry.z) obj, (ox.c) obj2)).invokeSuspend(jx.w.f15819a);
    }

    @Override // qx.a
    public final Object invokeSuspend(Object obj) {
        lb.w.j0(obj);
        Set set = this.f32449i;
        ...
        while (it.hasNext()) {
            arrayList.add(DictRule.copy$default((DictRule) it.next(), null, null, null, false, 0, 23, null));
        }
