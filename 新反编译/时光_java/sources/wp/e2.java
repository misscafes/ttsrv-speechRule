...
public final class e2 extends qx.i implements yx.p {
    ...
    public final /* synthetic */ Set f32366i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public e2(Set<Long> set, ox.c cVar) {
        super(2, cVar);
        this.f32366i = set;
    }
    ...
    public final ox.c create(Object obj, ox.c cVar) {
        return new e2(this.f32366i, cVar);
    }

    @Override // yx.p
    public final Object invoke(Object obj, Object obj2) {
        e2 e2Var = (e2) create((ry.z) obj, (ox.c) obj2);
        jx.w wVar = jx.w.f15819a;
        e2Var.invokeSuspend(wVar);
        return wVar;
    }
