...
public final class u extends ReplacementSpan {
    ...
    public TextPaint f29152n0;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final Paint.FontMetricsInt f29151i = new Paint.FontMetricsInt();
    public short Y = -1;
    public float Z = 1.0f;

    public u(t tVar) {
        cy.a.u(tVar, "rasterizer cannot be null");
        this.X = tVar;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L46
        L26:
            android.text.TextPaint r3 = r0.f29152n0
            if (r3 != 0) goto L31
        ...
        L94:
            u7.t r0 = r0.X
            sp.s2 r2 = r0.f29149b
            java.lang.Object r3 = r2.f27278n0
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: u7.u.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }

    @Override // android.text.style.ReplacementSpan
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        Paint.FontMetricsInt fontMetricsInt2 = this.f29151i;
        paint.getFontMetricsInt(fontMetricsInt2);
        float fAbs = Math.abs(fontMetricsInt2.descent - fontMetricsInt2.ascent) * 1.0f;
        t tVar = this.X;
        this.Z = fAbs / (tVar.b().a(14) != 0 ? r8.f30805b.getShort(r1 + r8.f30804a) : (short) 0);
        v7.a aVarB = tVar.b();
        int iA = aVarB.a(14);
        if (iA != 0) {
            aVarB.f30805b.getShort(iA + aVarB.f30804a);
        }
        short s2 = (short) ((tVar.b().a(12) != 0 ? r5.f30805b.getShort(r7 + r5.f30804a) : (short) 0) * this.Z);
        this.Y = s2;
