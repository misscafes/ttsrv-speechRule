...
public final class m0 extends e0 {
    ...
    public static final String[] f23680n0 = {"app_version", "ALTER TABLE messages ADD COLUMN app_version TEXT;", "app_version_int", "ALTER TABLE messages ADD COLUMN app_version_int INTEGER;"};
    public final l Y;
    public boolean Z;

    public m0(j1 j1Var) {
        super(j1Var);
        this.Y = new l(this, ((j1) this.f15942i).f23609i);
    }
    ...
    public final void C() {
        ...
        try {
            ...
            if (sQLiteDatabaseE == null || (iDelete = sQLiteDatabaseE.delete("messages", null, null)) <= 0) {
                return;
            }
            s0 s0Var = j1Var.f23611o0;
            j1.m(s0Var);
            s0Var.f23797w0.b(Integer.valueOf(iDelete), "Reset local analytics data. records");
        } catch (SQLiteException e11) {
            s0 s0Var2 = j1Var.f23611o0;
            j1.m(s0Var2);
            s0Var2.f23790o0.b(e11, "Error resetting local analytics data. error");
        }
    }
    ...
    */
    public final boolean D() {
        /*
            ...
            java.lang.Object r1 = r11.f15942i
            ph.j1 r1 = (ph.j1) r1
            r11.y()
            boolean r2 = r11.Z
            r3 = 0
            ...
            goto L99
        L10:
            android.content.Context r2 = r1.f23609i
        ...
        L21:
            ...
            r6 = 0
            r7 = 1
            android.database.sqlite.SQLiteDatabase r6 = r11.E()     // Catch: java.lang.Throwable -> L4b android.database.sqlite.SQLiteException -> L4d android.database.sqlite.SQLiteDatabaseLockedException -> L68 android.database.sqlite.SQLiteFullException -> L74
            if (r6 != 0) goto L2e
        ...
        L59:
            ph.s0 r9 = r1.f23611o0     // Catch: java.lang.Throwable -> L4b
            ph.j1.m(r9)     // Catch: java.lang.Throwable -> L4b
            ph.q0 r9 = r9.f23790o0     // Catch: java.lang.Throwable -> L4b
        ...
        L8c:
            throw r11
        L8d:
            ph.s0 r11 = r1.f23611o0
            ph.j1.m(r11)
            ph.q0 r11 = r11.f23792r0
            java.lang.String r0 = "Error deleting app launch break from local database in reasonable time"
            r11.a(r0)
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: ph.m0.D():boolean");
    }
 ...
 binds: [B:79:0x013c, B:96:0x016d, B:87:0x014e] A[DONT_GENERATE, DONT_INLINE]
  0x0150: PHI (r17v7 boolean) = (r17v4 boolean), (r17v5 boolean), (r17v8 boolean) binds: [B:79:0x013c, B:96:0x016d, B:87:0x014e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean F(int r19, byte[] r20) {
        /*
            Method dump skipped, instruction units count: 399
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ph.m0.F(int, byte[]):boolean");
    }
}
