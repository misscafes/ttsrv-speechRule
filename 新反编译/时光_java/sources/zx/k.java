...
public abstract class k {
    ...
    public static final Object[] f38782a = new Object[0];

    public static boolean a(float f7, Float f11) {
        return f11 != null && f7 == f11.floatValue();
    }
    ...
    public static void i(String str) {
        UninitializedPropertyAccessException uninitializedPropertyAccessException = new UninitializedPropertyAccessException(b.a.l("lateinit property ", str, " has not been initialized"));
        g(uninitializedPropertyAccessException, k.class.getName());
