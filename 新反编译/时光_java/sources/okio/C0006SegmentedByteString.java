...
public final class C0006SegmentedByteString extends ByteString {
    ...
    public void copyInto(int i10, byte[] bArr, int i11, int i12) {
        bArr.getClass();
        long j11 = i12;
        SegmentedByteString.checkOffsetAndCount(size(), i10, j11);
        SegmentedByteString.checkOffsetAndCount(bArr.length, i11, j11);
        int i13 = i12 + i10;
        int iC = p.c(this, i10);
        while (i10 < i13) {
            int i14 = iC == 0 ? 0 : getDirectory$okio()[iC - 1];
            int i15 = getDirectory$okio()[iC] - i14;
            int i16 = getDirectory$okio()[getSegments$okio().length + iC];
            int iMin = Math.min(i13, i15 + i14) - i10;
            int i17 = (i10 - i14) + i16;
            n.x0(getSegments$okio()[iC], i11, bArr, i17, i17 + iMin);
            i11 += iMin;
            i10 += iMin;
            iC++;
        }
    ...
    public byte internalGet$okio(int i10) {
        ...
        int iC = p.c(this, i10);
        return getSegments$okio()[iC][(i10 - (iC == 0 ? 0 : getDirectory$okio()[iC - 1])) + getDirectory$okio()[getSegments$okio().length + iC]];
    }
    ...
    public boolean rangeEquals(int i10, byte[] bArr, int i11, int i12) {
        ...
        while (i10 < i13) {
            ...
            int i16 = getDirectory$okio()[getSegments$okio().length + iC];
            int iMin = Math.min(i13, i15 + i14) - i10;
            if (!SegmentedByteString.arrayRangeEquals(getSegments$okio()[iC], (i10 - i14) + i16, bArr, i11, iMin)) {
                return false;
            }
            i11 += iMin;
            i10 += iMin;
    ...
    public ByteString substring(int i10, int i11) {
        ...
        if (i10 < 0) {
            a.d(b.a.i("beginIndex=", i10, " < 0"));
            return null;
        }
        if (iResolveDefaultParameter > size()) {
            StringBuilder sbQ = b.a.q(iResolveDefaultParameter, "endIndex=", " > length(");
            sbQ.append(size());
            sbQ.append(')');
        ...
        if (i12 < 0) {
            a.d(c.a(iResolveDefaultParameter, "endIndex=", " < beginIndex=", i10));
            return null;
        }
        ...
        int iC = p.c(this, i10);
        int iC2 = p.c(this, iResolveDefaultParameter - 1);
        byte[][] bArr = (byte[][]) n.D0(getSegments$okio(), iC, iC2 + 1);
        ...
        int i16 = iC != 0 ? getDirectory$okio()[iC - 1] : 0;
    ...
    public byte[] toByteArray() {
        ...
        while (i10 < length) {
            ...
            int i14 = getDirectory$okio()[i10];
            int i15 = i14 - i11;
            n.x0(getSegments$okio()[i10], i12, bArr, i13, i13 + i15);
            i12 += i15;
            i10++;
            i11 = i14;
        }
    ...
    public void write$okio(Buffer buffer, int i10, int i11) {
        ...
        int iC = p.c(this, i10);
        while (i10 < i12) {
            int i13 = iC == 0 ? 0 : getDirectory$okio()[iC - 1];
            int i14 = getDirectory$okio()[iC] - i13;
            int i15 = getDirectory$okio()[getSegments$okio().length + iC];
            int iMin = Math.min(i12, i14 + i13) - i10;
            int i16 = (i10 - i13) + i15;
            Segment segment = new Segment(getSegments$okio()[iC], i16, i16 + iMin, true, false);
    ...
    public boolean rangeEquals(int i10, ByteString byteString, int i11, int i12) {
        ...
        while (i10 < i13) {
            ...
            int i16 = getDirectory$okio()[getSegments$okio().length + iC];
            int iMin = Math.min(i13, i15 + i14) - i10;
            if (!byteString.rangeEquals(i11, getSegments$okio()[iC], (i10 - i14) + i16, iMin)) {
                return false;
            }
            i11 += iMin;
            i10 += iMin;
