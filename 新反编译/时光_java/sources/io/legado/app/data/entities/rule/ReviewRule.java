...
public final class ReviewRule implements Parcelable {
    ...
    private static final o jsonDeserializer = new a(3);

    public /* synthetic */ ReviewRule(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, int i10, f fVar) {
    ...
    public static final ReviewRule jsonDeserializer$lambda$0(p pVar, Type type, n nVar) {
        pVar.getClass();
        if (pVar instanceof r) {
            return (ReviewRule) a0.c().e(pVar, ReviewRule.class);
        }
        if (pVar instanceof s) {
            return (ReviewRule) a0.c().c(ReviewRule.class, pVar.i());
        }
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return k.c(this.reviewUrl, reviewRule.reviewUrl) && k.c(this.avatarRule, reviewRule.avatarRule) && k.c(this.contentRule, reviewRule.contentRule) && k.c(this.postTimeRule, reviewRule.postTimeRule) && k.c(this.reviewQuoteUrl, reviewRule.reviewQuoteUrl) && k.c(this.voteUpUrl, reviewRule.voteUpUrl) && k.c(this.voteDownUrl, reviewRule.voteDownUrl) && k.c(this.postReviewUrl, reviewRule.postReviewUrl) && k.c(this.postQuoteUrl, reviewRule.postQuoteUrl) && k.c(this.deleteUrl, reviewRule.deleteUrl);
    }
    ...
    public String toString() {
        ...
        String str9 = this.postQuoteUrl;
        String str10 = this.deleteUrl;
        StringBuilder sbT = b.a.t("ReviewRule(reviewUrl=", str, ", avatarRule=", str2, ", contentRule=");
        b.a.x(sbT, str3, ", postTimeRule=", str4, ", reviewQuoteUrl=");
        b.a.x(sbT, str5, ", voteUpUrl=", str6, ", voteDownUrl=");
        b.a.x(sbT, str7, ", postReviewUrl=", str8, ", postQuoteUrl=");
        return m2.k.q(sbT, str9, ", deleteUrl=", str10, ")");
    }
