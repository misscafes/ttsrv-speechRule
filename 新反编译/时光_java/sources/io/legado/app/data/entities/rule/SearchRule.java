...
public final class SearchRule implements BookListRule, Parcelable {
    ...
    private static final o jsonDeserializer = new a(4);

    public /* synthetic */ SearchRule(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, int i10, f fVar) {
    ...
    public static final SearchRule jsonDeserializer$lambda$0(p pVar, Type type, n nVar) {
        pVar.getClass();
        if (pVar instanceof r) {
            return (SearchRule) a0.c().e(pVar, SearchRule.class);
        }
        if (pVar instanceof s) {
            return (SearchRule) a0.c().c(SearchRule.class, pVar.i());
        }
        return null;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return k.c(this.checkKeyWord, searchRule.checkKeyWord) && k.c(this.bookList, searchRule.bookList) && k.c(this.name, searchRule.name) && k.c(this.author, searchRule.author) && k.c(this.intro, searchRule.intro) && k.c(this.kind, searchRule.kind) && k.c(this.lastChapter, searchRule.lastChapter) && k.c(this.updateTime, searchRule.updateTime) && k.c(this.bookUrl, searchRule.bookUrl) && k.c(this.coverUrl, searchRule.coverUrl) && k.c(this.wordCount, searchRule.wordCount);
    }
    ...
    public String toString() {
        ...
        String str10 = this.coverUrl;
        String str11 = this.wordCount;
        StringBuilder sbT = b.a.t("SearchRule(checkKeyWord=", str, ", bookList=", str2, ", name=");
        b.a.x(sbT, str3, ", author=", str4, ", intro=");
        b.a.x(sbT, str5, ", kind=", str6, ", lastChapter=");
        b.a.x(sbT, str7, ", updateTime=", str8, ", bookUrl=");
        b.a.x(sbT, str9, ", coverUrl=", str10, ", wordCount=");
