...
public abstract class g {
    ...
    public static final Type[] f28188a = new Type[0];
    ...
    public static void b(Type type) {
        if ((type instanceof Class) && ((Class) type).isPrimitive()) {
            ge.c.z("Primitive type is not allowed");
        }
    }
    ...
    public static Class f(Type type) {
        ...
        r00.a.j("Expected a Class, ParameterizedType, or GenericArrayType, but <", type, "> is of type ", type == null ? vd.d.NULL : type.getClass().getName());
        return null;
    }
    ...
    public static rl.p h(zl.b bVar) {
        boolean z11;
        try {
            try {
                bVar.P();
    ...
    /* JADX WARN: Type inference failed for: r12v3, types: [tl.f] */
    /* JADX WARN: Type inference failed for: r12v4, types: [tl.f] */
    ...
    */
    public static java.lang.reflect.Type i(java.lang.reflect.Type r10, java.lang.Class r11, java.lang.reflect.Type r12, java.util.HashMap r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: tl.g.i(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.HashMap):java.lang.reflect.Type");
    }
