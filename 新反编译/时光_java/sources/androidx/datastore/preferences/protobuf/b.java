...
public final class b extends am.h {
    ...
    public final FileInputStream f1476c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final byte[] f1477d;
    ...
    public int f1483j = Integer.MAX_VALUE;

    public b(FileInputStream fileInputStream) {
        Charset charset = p.f25039a;
        this.f1476c = fileInputStream;
        this.f1477d = new byte[ArchiveEntry.AE_IFIFO];
        this.f1478e = 0;
        this.f1480g = 0;
        this.f1482i = 0;
    }
    ...
    public final byte[] A(int i10) throws IOException {
        ...
        int i15 = this.f1478e - i12;
        int i16 = i10 - i15;
        FileInputStream fileInputStream = this.f1476c;
        if (i16 >= 4096) {
            try {
        ...
        System.arraycopy(this.f1477d, this.f1480g, bArr, 0, i15);
        this.f1482i += this.f1478e;
        this.f1480g = 0;
        this.f1478e = 0;
        while (i15 < i10) {
            try {
    ...
    public final ArrayList B(int i10) throws IOException {
        ...
        while (i10 > 0) {
            ...
            int i11 = 0;
            while (i11 < iMin) {
                int i12 = this.f1476c.read(bArr, i11, iMin - i11);
                if (i12 == -1) {
                    throw InvalidProtocolBufferException.n();
                }
                this.f1482i += i12;
    ...
    public final int C() throws InvalidProtocolBufferException {
        int i10 = this.f1480g;
        if (this.f1478e - i10 < 4) {
            I(4);
            i10 = this.f1480g;
        }
        this.f1480g = i10 + 4;
        byte[] bArr = this.f1477d;
    ...
    public final long G() throws InvalidProtocolBufferException {
        ...
        for (int i10 = 0; i10 < 64; i10 += 7) {
            if (this.f1480g == this.f1478e) {
                I(1);
            }
            int i11 = this.f1480g;
            this.f1480g = i11 + 1;
            byte b11 = this.f1477d[i11];
    ...
    public final void H() {
        int i10 = this.f1478e + this.f1479f;
        this.f1478e = i10;
        int i11 = this.f1482i + i10;
        int i12 = this.f1483j;
        if (i11 <= i12) {
            this.f1479f = 0;
            return;
    ...
    public final void I(int i10) throws InvalidProtocolBufferException {
        ...
        if (i10 <= (Integer.MAX_VALUE - this.f1482i) - this.f1480g) {
            throw InvalidProtocolBufferException.n();
        }
        throw InvalidProtocolBufferException.m();
    }
    ...
    public final boolean K(int i10) throws IOException {
        ...
        int i14 = this.f1482i;
        if (i10 <= (Integer.MAX_VALUE - i14) - i11 && i14 + i11 + i10 <= this.f1483j) {
            byte[] bArr = this.f1477d;
            if (i11 > 0) {
                if (i13 > i11) {
            ...
            int i15 = this.f1478e;
            try {
                int i16 = fileInputStream.read(bArr, i15, Math.min(bArr.length - i15, (Integer.MAX_VALUE - this.f1482i) - i15));
    ...
    @Override // am.h
    public final int b() {
        return this.f1482i + this.f1480g;
    }

    @Override // am.h
    public final boolean c() {
        return this.f1480g == this.f1478e && !K(1);
    }
    ...
    public final int e(int i10) throws InvalidProtocolBufferException {
        ...
        int i11 = this.f1482i + this.f1480g + i10;
        if (i11 < 0) {
    ...
    @Override // am.h
    public final q7.e g() throws IOException {
        int iE = E();
        int i10 = this.f1478e;
        int i11 = this.f1480g;
        int i12 = i10 - i11;
        ...
        byte[] bArrA = A(iE);
        if (bArrA != null) {
            return q7.e.e(bArrA, 0, bArrA.length);
        }
        int i13 = this.f1480g;
        int i14 = this.f1478e;
        int length = i14 - i13;
    ...
    public final String t() throws InvalidProtocolBufferException {
        ...
        if (iE > 0) {
            ...
            int i11 = this.f1480g;
            if (iE <= i10 - i11) {
                String str = new String(bArr, i11, iE, p.f25039a);
                this.f1480g += iE;
                return str;
            }
        }
        ...
        if (iE > this.f1478e) {
            return new String(z(iE), p.f25039a);
        }
        I(iE);
        String str2 = new String(bArr, this.f1480g, iE, p.f25039a);
        this.f1480g += iE;
        return str2;
    }
    ...
    public final String u() throws IOException {
        ...
        return n.f1523a.q(bArrZ, i10, iE);
    }
    ...
    public final boolean y(int i10) throws InvalidProtocolBufferException {
        ...
        int i12 = 0;
        if (i11 == 0) {
            int i13 = this.f1478e - this.f1480g;
            byte[] bArr = this.f1477d;
            if (i13 >= 10) {
                while (i12 < 10) {
                    int i14 = this.f1480g;
    ...
    public final byte[] z(int i10) throws IOException {
        ...
        byte[] bArr = new byte[i10];
        System.arraycopy(this.f1477d, i11, bArr, 0, length);
        int size = arrayListB.size();
        int i13 = 0;
        while (i13 < size) {
