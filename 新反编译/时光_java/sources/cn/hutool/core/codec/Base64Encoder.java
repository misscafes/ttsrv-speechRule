...
public class Base64Encoder {
    ...
    public static byte[] encode(byte[] bArr, boolean z11, boolean z12) {
        ...
        int i11 = length - 1;
        int i12 = ((i11 / 3) + 1) << 2;
        int i13 = i12 + (z11 ? ((i12 - 1) / 76) << 1 : 0);
        byte[] bArr2 = new byte[i13];
        byte[] bArr3 = z12 ? URL_SAFE_ENCODE_TABLE : STANDARD_ENCODE_TABLE;
        int i14 = 0;
        int i15 = 0;
        int i16 = 0;
        while (i14 < i10) {
            int i17 = i14 + 2;
            int i18 = ((bArr[i14 + 1] & ByteAsBool.UNKNOWN) << 8) | ((bArr[i14] & ByteAsBool.UNKNOWN) << 16);
            i14 += 3;
            int i19 = i18 | (bArr[i17] & ByteAsBool.UNKNOWN);
            bArr2[i15] = bArr3[(i19 >>> 18) & 63];
            bArr2[i15 + 1] = bArr3[(i19 >>> 12) & 63];
            bArr2[i15 + 2] = bArr3[(i19 >>> 6) & 63];
            int i21 = i15 + 4;
            bArr2[i15 + 3] = bArr3[i19 & 63];
            if (z11 && (i16 = i16 + 1) == 19 && i21 < i13 - 2) {
                int i22 = i15 + 5;
                bArr2[i21] = UnicodeProperties.MARK;
                i15 += 6;
                bArr2[i22] = 10;
                i16 = 0;
            } else {
        ...
        int i23 = length - i10;
        if (i23 > 0) {
            int i24 = (i23 == 2 ? (bArr[i11] & ByteAsBool.UNKNOWN) << 2 : 0) | ((bArr[i10] & ByteAsBool.UNKNOWN) << 10);
            bArr2[i13 - 4] = bArr3[i24 >> 12];
            bArr2[i13 - 3] = bArr3[(i24 >>> 6) & 63];
            if (z12) {
                int i25 = i13 - 2;
                if (2 == i23) {
                ...
                System.arraycopy(bArr2, 0, bArr4, 0, i25);
                return bArr4;
            }
            bArr2[i13 - 2] = i23 == 2 ? bArr3[i24 & 63] : (byte) 61;
            bArr2[i13 - 1] = 61;
        }
        return bArr2;
    }
