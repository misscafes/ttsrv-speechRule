...
public class TypeUtil {
    public static Type getActualType(Type type, Type type2) {
        ...
        if (type2 instanceof TypeVariable) {
            Map map = (Map) a.f25242a.computeIfAbsent(type, new f(type, 7));
    ...
    public static Type getFieldType(Class<?> cls, String str) throws Throwable {
        return getType((Field) ArrayUtil.firstMatch(new u(str, 2), j.d(cls)));
    }
    ...
    public static Map<Type, Type> getTypeMap(Class<?> cls) {
        return (Map) a.f25242a.computeIfAbsent(cls, new f(cls, 7));
    }
    ...
    public static Type getActualType(Type type, ParameterizedType parameterizedType) {
        if (hasTypeVariable(parameterizedType.getActualTypeArguments())) {
            ...
            if (ArrayUtil.isNotEmpty((Object[]) actualTypes)) {
                return new i(actualTypes, parameterizedType.getOwnerType(), parameterizedType.getRawType());
            }
        }
