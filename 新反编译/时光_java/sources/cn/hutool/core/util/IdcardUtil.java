...
public class IdcardUtil {
    ...
    public static class Idcard implements Serializable {
        ...
        public String toString() {
            StringBuilder sb2 = new StringBuilder("Idcard{provinceCode='");
    ...
    static {
        ...
        map.put("83", "台湾");
        map.put("91", "国外");
        map2.put(g.f(34, map2, g.f(33, map2, g.f(32, map2, g.f(31, map2, g.f(30, map2, g.f(29, map2, g.f(28, map2, g.f(27, map2, g.f(26, map2, g.f(25, map2, g.f(24, map2, g.f(23, map2, g.f(22, map2, g.f(21, map2, g.f(20, map2, g.f(19, map2, g.f(18, map2, g.f(17, map2, g.f(16, map2, g.f(15, map2, g.f(14, map2, g.f(13, map2, g.f(12, map2, g.f(11, map2, g.f(10, map2, 'A', 'B'), 'C'), 'D'), 'E'), 'F'), 'G'), 'H'), 'J'), 'K'), 'L'), 'M'), 'N'), 'P'), 'Q'), 'R'), 'S'), 'T'), 'U'), 'V'), 'X'), 'Y'), 'W'), 'Z'), 'I'), 'O'), 35);
    }

    public static String convert15To18(String str) {
        if (str.length() != 15 || !ReUtil.isMatch(k.f16645a, str)) {
            return null;
        }
        c cVarF = d.f(str.substring(6, 12), "yyMMdd");
        int i10 = c.Z;
        int i11 = cVarF.b().get(1);
        if (i11 > 2000) {
            i11 -= 100;
        }
    ...
    public static String convert18To15(String str) {
        return (vd.d.isNotBlank(str) && isValidCard18(str)) ? str.substring(0, 6).concat(str.substring(8, str.length() - 1)) : str;
    }

    public static int getAgeByIdCard(String str, Date date) throws Throwable {
        c cVarF = d.f(getBirthByIdCard(str), "yyyyMMdd");
        q6.d.N(cVarF, "Birthday can not be null !", new Object[0]);
        if (date == null) {
            date = new c();
        }
        long time = cVarF.getTime();
        long time2 = date.getTime();
        if (time > time2) {
            ge.c.z("Birthday is after dateToCompare!");
            return 0;
        }
    ...
    public static String getBirth(String str) {
        q6.d.L(str, "id card must be not blank!", new Object[0]);
    ...
    public static c getBirthDate(String str) {
        ...
        return new c(birthByIdCard, b.f8011f);
    }
    ...
    public static int getGenderByIdCard(String str) {
        ...
        int length = str.length();
        if (length != 15 && length != 18) {
            ge.c.z("ID Card length must be 15 or 18");
            return 0;
        }
        if (length == 15) {
            str = convert15To18(str);
    ...
    public static String getProvinceByIdCard(String str) {
        ...
        if (vd.d.isNotBlank(provinceCodeByIdCard)) {
    ...
    public static String[] isValidCard10(String str) {
        ...
        String strReplaceAll = str.replaceAll("[()]", vd.d.EMPTY);
    ...
    public static boolean isValidCard15(String str) {
        if (str != null && 15 == str.length() && ReUtil.isMatch(k.f16645a, str)) {
            if (CITY_CODES.get(str.substring(0, 2)) != null) {
                return s.a("19".concat(str.substring(6, 12)));
            }
        }
        return false;
    }

    public static boolean isValidCard18(String str, boolean z11) {
        if (str != null && 18 == str.length()) {
            if (CITY_CODES.get(str.substring(0, 2)) != null && s.a(str.substring(6, 14))) {
                String strSubstring = str.substring(0, 17);
                if (ReUtil.isMatch(k.f16645a, strSubstring)) {
                    return CharUtil.equals(getCheckCode18(strSubstring), str.charAt(17), z11);
                }
            }
        }
        return false;
    ...
    public static boolean isValidHKCard(String str) {
        ...
        for (char c11 : strSubstring.toCharArray()) {
            upperCase += Integer.parseInt(String.valueOf(c11)) * i10;
            i10--;
        }
    ...
    public static boolean isValidTWCard(String str) {
        ...
        int i10 = 8;
        for (char c11 : str.substring(1, 9).toCharArray()) {
            iIntValue += Integer.parseInt(String.valueOf(c11)) * i10;
            i10--;
        }
