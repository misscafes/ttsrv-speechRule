...
public class KeyUtil {
    ...
    public static SecretKey generateKey(String str, byte[] bArr) {
        q6.d.L(str, "Algorithm is blank!", new Object[0]);
    ...
    public static KeyPair generateKeyPair(String str, int i10, SecureRandom secureRandom, AlgorithmParameterSpec... algorithmParameterSpecArr) throws Throwable {
    ...
    public static String getAlgorithmAfterWith(String str) throws Throwable {
        q6.d.N(str, "algorithm must be not null !", new Object[0]);
    ...
    public static KeyStore readKeyStore(String str, File file, char[] cArr) throws Throwable {
        ...
        try {
            ...
            try {
                KeyStore keyStore = readKeyStore(str, bufferedInputStreamC, cArr);
    ...
    public static SecretKey generateKey(String str, int i10, SecureRandom secureRandom) {
