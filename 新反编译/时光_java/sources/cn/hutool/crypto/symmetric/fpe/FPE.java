...
public class FPE implements Serializable {
    ...
    /* JADX INFO: renamed from: cn.hutool.crypto.symmetric.fpe.FPE$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-47d7031f5d78718531f48f1c7640d5b20aa4ef3796b143da36b974009fbbf949 */
    ...
    public FPE(FPEMode fPEMode, byte[] bArr, AlphabetMapper alphabetMapper, byte[] bArr2) {
        ...
        if (bArr2 == null) {
            int i10 = AnonymousClass1.$SwitchMap$cn$hutool$crypto$symmetric$fpe$FPE$FPEMode[fPEMode.ordinal()];
            if (i10 == 1) {
                bArr2 = new byte[0];
            } else if (i10 == 2) {
                bArr2 = new byte[7];
