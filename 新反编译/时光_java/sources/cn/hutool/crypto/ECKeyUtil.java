...
public class ECKeyUtil {
    ...
    public static PrivateKey toSm2PrivateKey(ECPrivateKey eCPrivateKey) {
        try {
            return KeyUtil.generatePrivateKey("SM2", new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, SmUtil.ID_SM2_PUBLIC_KEY_PARAM), eCPrivateKey).getEncoded());
