...
public class SmUtil {
    ...
    public static byte[] changeC1C2C3ToC1C3C2(byte[] bArr, ECDomainParameters eCDomainParameters) {
        int fieldSize = ((eCDomainParameters.getCurve().getFieldSize() + 7) / 8) * 2;
        int i10 = fieldSize + 1;
        byte[] bArr2 = new byte[bArr.length];
        System.arraycopy(bArr, 0, bArr2, 0, i10);
        System.arraycopy(bArr, bArr.length - 32, bArr2, i10, 32);
        System.arraycopy(bArr, i10, bArr2, fieldSize + 33, (bArr.length - i10) - 32);
        return bArr2;
    }
    ...
    public static byte[] changeC1C3C2ToC1C2C3(byte[] bArr, ECDomainParameters eCDomainParameters) {
        ...
        byte[] bArr2 = new byte[bArr.length];
        System.arraycopy(bArr, 0, bArr2, 0, i10);
        System.arraycopy(bArr, fieldSize + 33, bArr2, i10, (bArr.length - i10) - 32);
        System.arraycopy(bArr, i10, bArr2, bArr.length - 32, 32);
        return bArr2;
    }
