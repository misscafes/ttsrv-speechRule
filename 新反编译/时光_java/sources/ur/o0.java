...
public final class o0 extends pp.g {
    ...
    public final /* synthetic */ p0 f29911l;
    ...
    public final void B(pp.c cVar, jc.a aVar) {
        ...
        p0 p0Var = this.f29911l;
        themeCheckBox.setOnCheckedChangeListener(new ms.a0(p0Var, 4, cVar));
        ConstraintLayout constraintLayout = d2Var.f33830a;
        constraintLayout.getClass();
        constraintLayout.setOnClickListener(new dr.c(d2Var, p0Var, cVar, 21));
        d2Var.f33832c.setOnClickListener(new dr.d(p0Var, 24, cVar));
    }
    ...
    public final void w(pp.c cVar, jc.a aVar, Object obj, List list) {
        ...
        gy.e[] eVarArr = p0.C1;
        p0 p0Var = this.f29911l;
        Object obj2 = p0Var.k0().f29933q0.get(cVar.d());
        obj2.getClass();
        themeCheckBox.setChecked(((Boolean) obj2).booleanValue());
        themeCheckBox.setText(httpTTS.getName());
        HttpTTS httpTTS2 = (HttpTTS) p0Var.k0().p0.get(cVar.d());
        d2Var.f33833d.setText(httpTTS2 == null ? "新增" : httpTTS.getLastUpdateTime() > httpTTS2.getLastUpdateTime() ? "更新" : "已有");
    }
