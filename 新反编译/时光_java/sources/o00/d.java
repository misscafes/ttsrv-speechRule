...
public final class d implements HostnameVerifier {
        ...
        try {
            ...
            if (subjectAlternativeNames != null) {
                ...
                for (List<?> list : subjectAlternativeNames) {
                    if (list != null && list.size() >= 2 && k.c(list.get(0), Integer.valueOf(i10)) && (obj = list.get(1)) != null) {
    ...
    */
    public static boolean b(java.lang.String r11, java.security.cert.X509Certificate r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: o00.d.b(java.lang.String, java.security.cert.X509Certificate):boolean");
    }
