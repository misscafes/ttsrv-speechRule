...
public abstract class d {
    ...
    public static String appendIfMissing(CharSequence charSequence, CharSequence charSequence2, boolean z11, CharSequence... charSequenceArr) {
        if (charSequence == null || isEmpty(charSequence2) || endWith(charSequence, charSequence2, z11)) {
            return str(charSequence);
        }
        if (ArrayUtil.isNotEmpty((Object[]) charSequenceArr)) {
            for (CharSequence charSequence3 : charSequenceArr) {
                if (endWith(charSequence, charSequence3, z11)) {
    ...
    public static String cleanBlank(CharSequence charSequence) {
        return filter(charSequence, new t9.b(21));
    }
    ...
    public static int compare(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        if (charSequence == charSequence2) {
            return 0;
        }
        return charSequence == null ? z11 ? -1 : 1 : charSequence2 == null ? z11 ? 1 : -1 : charSequence.toString().compareTo(charSequence2.toString());
    }

    public static int compareIgnoreCase(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        if (charSequence == charSequence2) {
            return 0;
        }
        return charSequence == null ? z11 ? -1 : 1 : charSequence2 == null ? z11 ? 1 : -1 : charSequence.toString().compareToIgnoreCase(charSequence2.toString());
    }

    public static int compareVersion(CharSequence charSequence, CharSequence charSequence2) {
        return ad.b.a(str(charSequence), str(charSequence2));
    }

    public static String concat(boolean z11, CharSequence... charSequenceArr) {
        e eVar = new e();
    ...
    public static boolean endWith(CharSequence charSequence, CharSequence charSequence2, boolean z11, boolean z12) {
        if (charSequence == null || charSequence2 == null) {
            return !z12 && charSequence == null && charSequence2 == null;
        }
        if (charSequence.toString().regionMatches(z11, charSequence.length() - charSequence2.length(), charSequence2.toString(), 0, charSequence2.length())) {
            return (z12 && equals(charSequence, charSequence2, z11)) ? false : true;
        }
        return false;
    }
    ...
    public static boolean equals(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        if (charSequence == null) {
        ...
        return z11 ? charSequence.toString().equalsIgnoreCase(charSequence2.toString()) : charSequence.toString().contentEquals(charSequence2);
    }

    public static boolean equalsAny(CharSequence charSequence, boolean z11, CharSequence... charSequenceArr) {
        if (ArrayUtil.isEmpty((Object[]) charSequenceArr)) {
            return false;
        }
        for (CharSequence charSequence2 : charSequenceArr) {
            if (equals(charSequence, charSequence2, z11)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean equalsCharAt(CharSequence charSequence, int i10, char c11) {
        return charSequence != null && i10 >= 0 && charSequence.length() > i10 && c11 == charSequence.charAt(i10);
    }
    ...
    public static String filter(CharSequence charSequence, kd.d dVar) {
    ...
    public static <T extends CharSequence> T firstNonBlank(T... tArr) {
        return (T) ArrayUtil.firstMatch(new t9.b(22), tArr);
    }

    public static <T extends CharSequence> T firstNonEmpty(T... tArr) {
        return (T) ArrayUtil.firstMatch(new t9.b(23), tArr);
    }
    ...
    public static String fixLength(CharSequence charSequence, char c11, int i10) {
        int length = i10 - charSequence.length();
        if (length <= 0) {
            return charSequence.toString();
        }
        return ((Object) charSequence) + repeat(c11, length);
    }

    public static String format(CharSequence charSequence, Object... objArr) {
        return charSequence == null ? NULL : (ArrayUtil.isEmpty(objArr) || isBlank(charSequence)) ? charSequence.toString() : ic.a.t(charSequence.toString(), objArr);
    }
    ...
    public static int indexOf(CharSequence charSequence, CharSequence charSequence2, int i10, boolean z11) {
        if (isEmpty(charSequence) || isEmpty(charSequence2)) {
            return equals(charSequence, charSequence2) ? 0 : -1;
        }
        xd.c cVar = new xd.c(charSequence2, z11);
        cVar.e(charSequence);
        return cVar.f(i10);
    }
    ...
    public static boolean isAllCharMatch(CharSequence charSequence, kd.e eVar) {
        if (isBlank(charSequence)) {
            return false;
        }
        int length = charSequence.length();
        ...
        } while (eVar.j(Character.valueOf(charSequence.charAt(length))));
        return false;
    }
    ...
    public static boolean isCharEquals(CharSequence charSequence) throws Throwable {
        kd.a aVar = new kd.a(1, "Str to check must be not empty!", new Object[0]);
        if (isEmpty(charSequence)) {
    ...
    public static boolean isNumeric(CharSequence charSequence) {
        return isAllCharMatch(charSequence, new t9.b(20));
    }

    public static boolean isSubEquals(CharSequence charSequence, int i10, CharSequence charSequence2, int i11, int i12, boolean z11) {
        if (charSequence == null || charSequence2 == null) {
            return false;
        }
        return charSequence.toString().regionMatches(z11, i10, charSequence2.toString(), i11, i12);
    }
    ...
    public static int lastIndexOf(CharSequence charSequence, CharSequence charSequence2, int i10, boolean z11) {
        if (isEmpty(charSequence) || isEmpty(charSequence2)) {
            return equals(charSequence, charSequence2) ? 0 : -1;
        }
        xd.c cVar = new xd.c(charSequence2, z11);
    ...
    public static String maxLength(CharSequence charSequence, int i10) throws Throwable {
        q6.d.G(i10 > 0, "[Assertion failed] - this expression must be true", new Object[0]);
        if (charSequence == null) {
            return null;
        }
    ...
    public static String padAfter(CharSequence charSequence, int i10, char c11) {
        if (charSequence == null) {
            return null;
        }
        int length = charSequence.length();
        return length == i10 ? charSequence.toString() : length > i10 ? sub(charSequence, length - i10, length) : charSequence.toString().concat(repeat(c11, i10 - length));
    }
    ...
    public static String prependIfMissing(CharSequence charSequence, CharSequence charSequence2, boolean z11, CharSequence... charSequenceArr) {
        if (charSequence == null || isEmpty(charSequence2) || startWith(charSequence, charSequence2, z11)) {
            return str(charSequence);
        }
        if (charSequenceArr != null && charSequenceArr.length > 0) {
            for (CharSequence charSequence3 : charSequenceArr) {
                if (startWith(charSequence, charSequence3, z11)) {
                    return charSequence.toString();
                }
            }
        }
    ...
    public static String repeat(CharSequence charSequence, int i10) {
        ...
        int length = charSequence.length();
        long j11 = ((long) length) * ((long) i10);
        int i11 = (int) j11;
        if (i11 != j11) {
            throw new ArrayIndexOutOfBoundsException(b.a.h(j11, "Required String length is too large: "));
        }
    ...
    public static String replace(CharSequence charSequence, int i10, CharSequence charSequence2, CharSequence charSequence3, boolean z11) {
        if (isEmpty(charSequence) || isEmpty(charSequence2)) {
            return str(charSequence);
        }
        ...
        while (true) {
            int iIndexOf = indexOf(charSequence, charSequence2, i10, z11);
            if (iIndexOf <= -1) {
                break;
            }
    ...
    public static String replaceFirst(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, boolean z11) {
        if (isEmpty(charSequence)) {
            return str(charSequence);
        }
        int iIndexOf = indexOf(charSequence, charSequence2, 0, z11);
    ...
    public static String replaceLast(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, boolean z11) {
        if (isEmpty(charSequence)) {
            return str(charSequence);
        }
        int iLastIndexOf = lastIndexOf(charSequence, charSequence2, charSequence.length(), z11);
        return -1 == iLastIndexOf ? str(charSequence) : replace(charSequence, iLastIndexOf, charSequence2, charSequence3, z11);
    }

    public static List<String> split(CharSequence charSequence, CharSequence charSequence2, int i10, boolean z11, boolean z12) {
        return k0.d.V(charSequence, charSequence2 == null ? null : charSequence2.toString(), i10, z11, z12);
    }

    public static String[] splitToArray(CharSequence charSequence, CharSequence charSequence2) {
        return charSequence == null ? new String[0] : k0.d.Y(charSequence.toString(), str(charSequence2));
    }

    public static int[] splitToInt(CharSequence charSequence, char c11) {
        return (int[]) hh.f.n(int[].class, splitTrim(charSequence, c11));
    }

    public static long[] splitToLong(CharSequence charSequence, char c11) {
        return (long[]) hh.f.n(long[].class, splitTrim(charSequence, c11));
    }

    public static List<String> splitTrim(CharSequence charSequence, char c11) {
        return splitTrim(charSequence, c11, -1);
    }

    public static boolean startWith(CharSequence charSequence, CharSequence charSequence2, boolean z11, boolean z12) {
        if (charSequence == null || charSequence2 == null) {
            return !z12 && charSequence == null && charSequence2 == null;
        }
        if (charSequence.toString().regionMatches(z11, 0, charSequence2.toString(), 0, charSequence2.length())) {
            return (z12 && equals(charSequence, charSequence2, z11)) ? false : true;
        }
        return false;
    }
    ...
    public static String subAfter(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        if (isEmpty(charSequence)) {
            if (charSequence == null) {
                return null;
            }
        ...
        String string = charSequence.toString();
        String string2 = charSequence2.toString();
        int iLastIndexOf = z11 ? string.lastIndexOf(string2) : string.indexOf(string2);
        return (-1 == iLastIndexOf || charSequence.length() + (-1) == iLastIndexOf) ? EMPTY : string.substring(charSequence2.length() + iLastIndexOf);
    }

    public static String subBefore(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
    ...
    public static String subByCodePoint(CharSequence charSequence, int i10, int i11) {
        ...
        charSequence.toString().codePoints().skip(i10).limit(i11 - i10).forEach(new IntConsumer() { // from class: vd.c
    ...
    public static String subPreGbk(CharSequence charSequence, int i10, boolean z11) {
        if (isEmpty(charSequence)) {
            return str(charSequence);
        }
    ...
    public static String swapCase(String str) {
        ...
        for (int i10 = 0; i10 < charArray.length; i10++) {
            ...
            if (Character.isUpperCase(c11)) {
                charArray[i10] = Character.toLowerCase(c11);
            } else if (Character.isTitleCase(c11)) {
                charArray[i10] = Character.toLowerCase(c11);
            } else if (Character.isLowerCase(c11)) {
                charArray[i10] = Character.toUpperCase(c11);
            }
        }
    ...
    public static String toCamelCase(CharSequence charSequence) {
        return hn.b.I(charSequence);
    }

    public static String toSymbolCase(CharSequence charSequence, char c11) {
        return hn.b.K(charSequence, c11);
    }

    public static String toUnderlineCase(CharSequence charSequence) {
        return hn.b.L(charSequence);
    }
    ...
    public static String unWrap(CharSequence charSequence, char c11, char c12) {
        return isEmpty(charSequence) ? str(charSequence) : (charSequence.charAt(0) == c11 && charSequence.charAt(charSequence.length() - 1) == c12) ? sub(charSequence, 1, charSequence.length() - 1) : charSequence.toString();
    }
    ...
    public static String upperFirstAndAddPre(CharSequence charSequence, String str) {
        ...
        sbJ.append(upperFirst(charSequence));
        return sbJ.toString();
    }
    ...
    public static <T> String join(CharSequence charSequence, Iterable<T> iterable) {
        return fh.a.R(charSequence, iterable);
    }

    public static String toCamelCase(CharSequence charSequence, char c11) {
        return hn.b.J(charSequence, c11);
    }
    ...
    public static List<String> splitTrim(CharSequence charSequence, char c11, int i10) {
        return split(charSequence, c11, i10, true, true);
    }
    ...
    public static List<String> split(CharSequence charSequence, char c11, int i10) {
        return split(charSequence, c11, i10, false, false);
    }

    public static int[] splitToInt(CharSequence charSequence, CharSequence charSequence2) {
        return (int[]) hh.f.n(int[].class, splitTrim(charSequence, charSequence2));
    }

    public static long[] splitToLong(CharSequence charSequence, CharSequence charSequence2) {
        return (long[]) hh.f.n(long[].class, splitTrim(charSequence, charSequence2));
    }

    public static List<String> split(CharSequence charSequence, char c11, boolean z11, boolean z12) {
        return split(charSequence, c11, 0, z11, z12);
    }

    public static List<String> split(CharSequence charSequence, char c11, int i10, boolean z11, boolean z12) {
        return k0.d.U(charSequence, c11, i10, z11, z12);
    }

    public static boolean contains(CharSequence charSequence, char c11) {
        return indexOf(charSequence, c11) > -1;
    }

    public static <R> List<R> split(CharSequence charSequence, char c11, int i10, boolean z11, Function<String, R> function) {
        return k0.d.T(charSequence, c11, i10, z11, function);
    }
    ...
    public static List<String> split(CharSequence charSequence, CharSequence charSequence2, boolean z11, boolean z12) {
        return split(charSequence, charSequence2, 0, z11, z12);
    }

    public static List<String> split(CharSequence charSequence, char c11) {
        return split(charSequence, c11, 0);
    }

    public static String[] splitToArray(CharSequence charSequence, char c11) {
        return splitToArray(charSequence, c11, 0);
    }

    public static String[] split(CharSequence charSequence, int i10) {
        return k0.d.W(i10, charSequence);
    }

    public static String[] splitToArray(CharSequence charSequence, char c11, int i10) throws Throwable {
        q6.d.N(charSequence, "Text must be not null!", new Object[0]);
        return k0.d.X(charSequence.toString(), c11, i10);
    }
    ...
    public static boolean isSubEquals(CharSequence charSequence, int i10, CharSequence charSequence2, boolean z11) {
        return isSubEquals(charSequence, i10, charSequence2, 0, charSequence2.length(), z11);
    }
    ...
    public static int indexOf(CharSequence charSequence, char c11, int i10) {
        if (charSequence instanceof String) {
            return ((String) charSequence).indexOf(c11, i10);
        }
        return indexOf(charSequence, c11, i10, -1);
    }

    public static String padPre(CharSequence charSequence, int i10, char c11) {
        if (charSequence == null) {
            return null;
        }
        int length = charSequence.length();
        ...
        return repeat(c11, i10 - length).concat(charSequence.toString());
    }
    ...
    public static boolean isWrap(CharSequence charSequence, char c11) {
        return isWrap(charSequence, c11, c11);
    }
    ...
    public static int indexOf(CharSequence charSequence, char c11, int i10, int i11) {
        if (isEmpty(charSequence)) {
            return -1;
        }
        xd.a aVar = new xd.a(c11);
        aVar.e(charSequence);
        aVar.c(i11);
        return aVar.f(i10);
    }

    public static boolean isWrap(CharSequence charSequence, char c11, char c12) {
        return charSequence != null && charSequence.charAt(0) == c11 && charSequence.charAt(charSequence.length() - 1) == c12;
    }

    public static int indexOf(CharSequence charSequence, char c11) {
        return indexOf(charSequence, c11, 0);
    }

    public static String unWrap(CharSequence charSequence, String str, String str2) {
        if (isWrap(charSequence, str, str2)) {
            return sub(charSequence, str.length(), charSequence.length() - str2.length());
        }
        return charSequence.toString();
    }

    public static String center(CharSequence charSequence, int i10, char c11) {
        if (charSequence != null && i10 > 0) {
            int length = charSequence.length();
            int i11 = i10 - length;
            if (i11 <= 0) {
            ...
            return padAfter(padPre(charSequence, (i11 / 2) + length, c11), i10, c11).toString();
        }
        return str(charSequence);
    }
    ...
    public static String unWrap(CharSequence charSequence, char c11) {
        return unWrap(charSequence, c11, c11);
    }

    public static boolean startWith(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        return startWith(charSequence, charSequence2, z11, false);
    }
    ...
    public static boolean startWith(CharSequence charSequence, char c11) {
        return !isEmpty(charSequence) && c11 == charSequence.charAt(0);
    }

    public static boolean isSurround(CharSequence charSequence, char c11, char c12) {
        return !isBlank(charSequence) && charSequence.length() >= 2 && charSequence.charAt(0) == c11 && charSequence.charAt(charSequence.length() - 1) == c12;
    }

    public static int count(CharSequence charSequence, char c11) {
        if (isEmpty(charSequence)) {
            return 0;
        }
        int length = charSequence.length();
        ...
        for (int i11 = 0; i11 < length; i11++) {
            if (c11 == charSequence.charAt(i11)) {
                i10++;
            }
        }
        return i10;
    ...
    public static boolean endWith(CharSequence charSequence, CharSequence charSequence2, boolean z11) {
        return endWith(charSequence, charSequence2, z11, false);
    }
    ...
    public static String subAfter(CharSequence charSequence, char c11, boolean z11) {
        if (isEmpty(charSequence)) {
            if (charSequence == null) {
                return null;
            }
        ...
        String string = charSequence.toString();
        int iLastIndexOf = z11 ? string.lastIndexOf(c11) : string.indexOf(c11);
    ...
    public static boolean endWith(CharSequence charSequence, char c11) {
        return !isEmpty(charSequence) && c11 == charSequence.charAt(charSequence.length() - 1);
    }

    public static String subBefore(CharSequence charSequence, char c11, boolean z11) {
        if (isEmpty(charSequence)) {
            if (charSequence == null) {
                return null;
            }
    ...
    public static String trim(CharSequence charSequence, int i10) {
        return trim(charSequence, i10, new b());
    }
    ...
    public static String repeat(char c11, int i10) {
        if (i10 <= 0) {
            return EMPTY;
        }
        char[] cArr = new char[i10];
    ...
    public static String replaceChars(CharSequence charSequence, String str, CharSequence charSequence2) {
        if (!isEmpty(charSequence) && !isEmpty(str)) {
            return replaceChars(charSequence, str.toCharArray(), charSequence2);
        }
        return str(charSequence);
    }
    ...
    public static String replace(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, boolean z11) {
        return replace(charSequence, 0, charSequence2, charSequence3, z11);
    }
    ...
    public static String replace(CharSequence charSequence, int i10, int i11, char c11) {
        if (isEmpty(charSequence)) {
            return str(charSequence);
        }
        String str = str(charSequence);
    ...
    public static String replace(CharSequence charSequence, Pattern pattern, md.a aVar) {
        return ReUtil.replaceAll(charSequence, pattern, aVar);
    }

    public static String replace(CharSequence charSequence, String str, md.a aVar) {
