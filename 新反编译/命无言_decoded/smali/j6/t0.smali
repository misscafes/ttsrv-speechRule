.class public abstract synthetic Lj6/t0;
...
.method public static bridge synthetic B(Ld9/i;)Ljava/lang/ThreadLocal;
    .locals 0
...
.method public static bridge synthetic d(Landroid/content/Context;Luu/h;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    .locals 0
...
.method public static bridge synthetic f(Landroid/media/AudioFocusRequest$Builder;)Landroid/media/AudioFocusRequest$Builder;
    .locals 1
...
.method public static bridge synthetic h(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioManager$OnAudioFocusChangeListener;Landroid/os/Handler;)Landroid/media/AudioFocusRequest$Builder;
    .locals 0
...
.method public static bridge synthetic k(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/OutputStream;
    .locals 0
...
.method public static bridge synthetic l(Ljava/time/LocalDate;Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
    .locals 0
...
.method public static bridge synthetic m(Ld9/i;)Ljava/lang/ThreadLocal;
    .locals 0
...
.method public static bridge synthetic n(Ljava/nio/file/Path;)Ljava/net/URI;
    .locals 0
...
.method public static bridge synthetic o(Ljava/net/URI;Ljava/util/HashMap;)Ljava/nio/file/FileSystem;
    .locals 0

    .line 1
    invoke-static {p0, p1}, Ljava/nio/file/FileSystems;->newFileSystem(Ljava/net/URI;Ljava/util/Map;)Ljava/nio/file/FileSystem;
...
.method public static bridge synthetic q()Ljava/time/Duration;
    .locals 1
...
.method public static bridge synthetic r(Landroid/text/Editable;)Ljava/time/LocalDate;
    .locals 0
...
.method public static bridge synthetic s(Ljava/lang/String;Ljava/time/format/DateTimeFormatter;)Ljava/time/LocalDate;
    .locals 0
...
.method public static bridge synthetic u(Ljava/time/Instant;)Ljava/util/Date;
    .locals 0
...
.method public static bridge synthetic v(Landroid/animation/AnimatorSet;J)V
    .locals 0
...
.method public static bridge synthetic w(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Landroid/os/Handler;I)V
    .locals 6
...
.method public static bridge synthetic x(Lio/github/rosemoe/sora/widget/CodeEditor;)V
    .locals 1
