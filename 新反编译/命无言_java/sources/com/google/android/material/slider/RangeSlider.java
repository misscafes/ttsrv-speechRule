...
public class RangeSlider extends e {
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.X1 = gVar.f10936i;
        int i10 = gVar.f10937v;
        this.Y1 = i10;
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        gVar.f10936i = this.X1;
        gVar.f10937v = this.Y1;
        return gVar;
    }
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray typedArrayN = c0.n(context, attributeSet, a.V, i10, R.style.Widget_MaterialComponents_Slider, new int[0]);
        if (typedArrayN.hasValue(1)) {
            TypedArray typedArrayObtainTypedArray = typedArrayN.getResources().obtainTypedArray(typedArrayN.getResourceId(1, 0));
            ArrayList arrayList = new ArrayList();
            for (int i11 = 0; i11 < typedArrayObtainTypedArray.length(); i11++) {
                arrayList.add(Float.valueOf(typedArrayObtainTypedArray.getFloat(i11, -1.0f)));
            }
            setValues(arrayList);
        }
        this.X1 = typedArrayN.getDimension(0, 0.0f);
        typedArrayN.recycle();
    }
