...
public abstract class m {
    ...
    public static final eh.h f4418a;

    static {
        if (l1.f6641e && l1.f6640d) {
            Class cls = eh.c.f6605a;
        }
        f4418a = new eh.h();
    }
    ...
    public static String b(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
        ...
        while (i10 < i12) {
            ...
            if (b11 >= 0) {
                ...
                byte b15 = bArr[i17];
                int i18 = i13 + 1;
                if (b1.b(b14) || ((b11 == -32 && b14 < -96) || ((b11 == -19 && b14 >= -96) || b1.b(b15)))) {
                    throw InvalidProtocolBufferException.d();
                }
                ...
                byte b18 = bArr[i19];
                int i20 = i13 + 1;
                if (b1.b(b16) || (((b16 + 112) + (b11 << 28)) >> 30) != 0 || b1.b(b17) || b1.b(b18)) {
                    throw InvalidProtocolBufferException.d();
                }
                int i21 = ((b16 & Utf8.REPLACEMENT_BYTE) << 12) | ((b11 & 7) << 18) | ((b17 & Utf8.REPLACEMENT_BYTE) << 6) | (b18 & Utf8.REPLACEMENT_BYTE);
                cArr[i13] = (char) ((i21 >>> 10) + Utf8.HIGH_SURROGATE_HEADER);
