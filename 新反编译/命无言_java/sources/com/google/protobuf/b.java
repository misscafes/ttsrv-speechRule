...
public final class b extends eh.i {
    ...
    public int f4380j = CodeRangeBuffer.LAST_CODE_POINT;

    public b(eh.a aVar) {
        Charset charset = a0.f6593a;
        this.f4373c = aVar;
        this.f4374d = new byte[4096];
        this.f4375e = 0;
        this.f4377g = 0;
        this.f4379i = 0;
    }
    ...
    public final byte[] A(int i10) throws IOException {
        ...
        int i15 = this.f4375e - i12;
        int i16 = i10 - i15;
        eh.a aVar = this.f4373c;
        if (i16 >= 4096) {
            try {
        ...
        System.arraycopy(this.f4374d, this.f4377g, bArr, 0, i15);
        this.f4379i += this.f4375e;
        this.f4377g = 0;
        this.f4375e = 0;
        while (i15 < i10) {
            try {
    ...
    public final ArrayList B(int i10) throws IOException {
        ...
        while (i10 > 0) {
            ...
            int i11 = 0;
            while (i11 < iMin) {
                int i12 = this.f4373c.read(bArr, i11, iMin - i11);
                if (i12 == -1) {
                    throw InvalidProtocolBufferException.n();
                }
                this.f4379i += i12;
    ...
    public final long G() throws InvalidProtocolBufferException {
        ...
        for (int i10 = 0; i10 < 64; i10 += 7) {
            if (this.f4377g == this.f4375e) {
                I(1);
            }
            int i11 = this.f4377g;
            this.f4377g = i11 + 1;
            byte b10 = this.f4374d[i11];
            j3 |= ((long) (b10 & 127)) << i10;
            if ((b10 & 128) == 0) {
                return j3;
            }
    ...
    public final void H() {
        int i10 = this.f4375e + this.f4376f;
        this.f4375e = i10;
        int i11 = this.f4379i + i10;
        int i12 = this.f4380j;
        if (i11 <= i12) {
            this.f4376f = 0;
            return;
    ...
    public final void I(int i10) throws InvalidProtocolBufferException {
        ...
        if (i10 <= (CodeRangeBuffer.LAST_CODE_POINT - this.f4379i) - this.f4377g) {
            throw InvalidProtocolBufferException.n();
        }
        throw InvalidProtocolBufferException.m();
    }
    ...
    public final void J(int i10) throws InvalidProtocolBufferException {
        ...
        while (i13 < i10) {
            ...
            try {
                try {
                    long jSkip = aVar.skip(j3);
                    if (jSkip < 0 || jSkip > j3) {
                        throw new IllegalStateException(eh.a.class + "#skip returned invalid result: " + jSkip + "\nThe InputStream implementation is buggy.");
                    }
                    if (jSkip == 0) {
                        break;
                    } else {
    ...
    public final boolean K(int i10) throws IOException {
        ...
        int i14 = this.f4379i;
        if (i10 <= (CodeRangeBuffer.LAST_CODE_POINT - i14) - i11 && i14 + i11 + i10 <= this.f4380j) {
            byte[] bArr = this.f4374d;
            if (i11 > 0) {
                if (i13 > i11) {
            ...
            int i15 = this.f4375e;
            try {
                int i16 = aVar.read(bArr, i15, Math.min(bArr.length - i15, (CodeRangeBuffer.LAST_CODE_POINT - this.f4379i) - i15));
    ...
    @Override // eh.i
    public final int b() {
        return this.f4379i + this.f4377g;
    }

    @Override // eh.i
    public final boolean c() {
        return this.f4377g == this.f4375e && !K(1);
    }
    ...
    public final int e(int i10) throws InvalidProtocolBufferException {
        ...
        int i11 = this.f4379i + this.f4377g + i10;
        int i12 = this.f4380j;
        if (i11 > i12) {
            throw InvalidProtocolBufferException.n();
        }
    ...
    public final boolean y(int i10) throws InvalidProtocolBufferException {
        ...
        int i12 = 0;
        if (i11 == 0) {
            int i13 = this.f4375e - this.f4377g;
            byte[] bArr = this.f4374d;
            if (i13 >= 10) {
                while (i12 < 10) {
                    int i14 = this.f4377g;
    ...
    public final byte[] z(int i10) throws IOException {
        ...
        byte[] bArr = new byte[i10];
        System.arraycopy(this.f4374d, i11, bArr, 0, length);
