...
class LZWEncoder {
    ...
    int cur_accum = 0;
    int cur_bits = 0;
    int[] masks = {0, 1, 3, 7, 15, 31, 63, Token.SWITCH, StackType.MASK_POP_USED, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535};
    ...
    public void char_out(byte b10, OutputStream outputStream) throws IOException {
    ...
    public void compress(int i10, OutputStream outputStream) throws IOException {
        ...
        while (true) {
            ...
            int i17 = (iNextPixel2 << this.maxbits) + iNextPixel;
            int i18 = (iNextPixel2 << i15) ^ iNextPixel;
            int i19 = this.htab[i18];
            if (i19 == i17) {
                iNextPixel = this.codetab[i18];
            } else {
                if (i19 >= 0) {
                    int i20 = i16 - i18;
                    if (i18 == 0) {
    ...
    public void output(int i10, OutputStream outputStream) throws IOException {
        ...
        while (this.cur_bits >= 8) {
            char_out((byte) (this.cur_accum & StackType.MASK_POP_USED), outputStream);
            this.cur_accum >>= 8;
            this.cur_bits -= 8;
        }
