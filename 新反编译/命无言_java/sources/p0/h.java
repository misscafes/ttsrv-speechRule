...
public final class h extends g {
    ...
    public h(v vVar, d dVar) {
        String str;
        String str2 = vVar.a() ? i.f19529d : i.f19528c;
        try {
            switch (dVar.f19516a) {
                case 0:
    ...
    public final void b() {
        super.b();
        GLES20.glUniform1i(this.f19523e, 0);
        GLES20.glEnableVertexAttribArray(this.f19525g);
        i.b("glEnableVertexAttribArray");
        GLES20.glVertexAttribPointer(this.f19525g, 2, 5126, false, 0, (Buffer) i.f19534i);
    ...
    public h(v vVar, f fVar) {
        d dVar;
        if (vVar.a()) {
            n7.a.d("No default sampler shader available for" + fVar, fVar != f.f19517i);
            if (fVar == f.A) {
                dVar = i.f19532g;
            } else {
                dVar = i.f19531f;
