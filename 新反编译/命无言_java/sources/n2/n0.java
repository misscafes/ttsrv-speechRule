...
public final class n0 extends a implements RandomAccess {
    ...
    public final boolean add(Object obj) {
        b();
        int i10 = this.A;
        Object[] objArr = this.f17400v;
        if (i10 == objArr.length) {
            this.f17400v = Arrays.copyOf(objArr, ((i10 * 3) / 2) + 1);
        }
        Object[] objArr2 = this.f17400v;
        int i11 = this.A;
        this.A = i11 + 1;
        objArr2[i11] = obj;
    ...
    public final Object get(int i10) {
        c(i10);
        return this.f17400v[i10];
    }

    @Override // n2.r
    public final r i(int i10) {
        if (i10 >= this.A) {
            return new n0(Arrays.copyOf(this.f17400v, i10), this.A);
        }
    ...
    public final void add(int i10, Object obj) {
        ...
        if (i10 >= 0 && i10 <= (i11 = this.A)) {
            ...
            if (i11 < objArr.length) {
                ...
                System.arraycopy(this.f17400v, i10, objArr2, i10 + 1, this.A - i10);
                this.f17400v = objArr2;
            }
            this.f17400v[i10] = obj;
            this.A++;
            ((AbstractList) this).modCount++;
            return;
        }
