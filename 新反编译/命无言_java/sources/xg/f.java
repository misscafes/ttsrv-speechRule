...
public abstract class f {
    ...
    public static final Type[] f28023a = new Type[0];

    public static Type a(Type type) {
        if (type instanceof Class) {
            Class cls = (Class) type;
            return cls.isArray() ? new d(a(cls.getComponentType())) : cls;
        }
        if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new n8.j(parameterizedType.getOwnerType(), (Class) parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
    ...
    public static Class g(Type type) {
        ...
        throw new IllegalArgumentException("Expected a Class, ParameterizedType, or GenericArrayType, but <" + type + "> is of type " + (type == null ? y8.d.NULL : type.getClass().getName()));
    }
    ...
    public static vg.s i(dh.a aVar) {
        boolean z4;
        try {
            try {
                aVar.a0();
    ...
    /* JADX WARN: Type inference failed for: r12v3, types: [xg.e] */
    /* JADX WARN: Type inference failed for: r12v4, types: [xg.e] */
    ...
    */
    public static java.lang.reflect.Type k(java.lang.reflect.Type r10, java.lang.Class r11, java.lang.reflect.Type r12, java.util.HashMap r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: xg.f.k(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.HashMap):java.lang.reflect.Type");
    }
