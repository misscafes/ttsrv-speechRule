...
public final class q extends cr.i implements lr.p {
    ...
    public final /* synthetic */ byte[] f10022v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(byte[] bArr, String str, t tVar, ar.d dVar) {
        super(2, dVar);
        this.f10022v = bArr;
        this.A = str;
        this.X = tVar;
    ...
    public final ar.d create(Object obj, ar.d dVar) {
        return new q(this.f10022v, this.A, this.X, dVar);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoStackTraceException {
        ...
        if (i10 == 0) {
            l3.c.F(obj);
            RequestBody requestBodyCreate$default = RequestBody.Companion.create$default(RequestBody.Companion, this.f10022v, MediaType.Companion.get(this.A), 0, 0, 6, (Object) null);
