...
public class AppCompatImageButton extends ImageButton {
    ...
    public final n3.d f774i;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final b5.a f775v;
    ...
    public final void drawableStateChanged() {
        ...
        n3.d dVar = this.f774i;
        if (dVar != null) {
            dVar.b();
        }
        b5.a aVar = this.f775v;
        if (aVar != null) {
            aVar.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f775v.A).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
