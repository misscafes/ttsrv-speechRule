...
public class SwitchPreference extends TwoStatePreference {
    ...
    public SwitchPreference(Context context, AttributeSet attributeSet) {
        int iB = r1.a.b(context, R.attr.switchPreferenceStyle, android.R.attr.switchPreferenceStyle);
        super(context, attributeSet, iB);
        this.U0 = new a(this, 1);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a0.f14935l, iB, 0);
    ...
    public final void o(z zVar) {
        super.o(zVar);
        G(zVar.s(android.R.id.switch_widget));
