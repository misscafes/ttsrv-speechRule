...
public abstract class b {
    ...
    public static final char[] f26972a = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'".toCharArray();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final char[] f26973b = "0123456789&\r\t,:#-.$/+%*=^".toCharArray();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final BigInteger[] f26974c;

    static {
        BigInteger[] bigIntegerArr = new BigInteger[16];
        f26974c = bigIntegerArr;
        bigIntegerArr[0] = BigInteger.ONE;
        BigInteger bigIntegerValueOf = BigInteger.valueOf(900L);
        bigIntegerArr[1] = bigIntegerValueOf;
        int i10 = 2;
        while (true) {
            BigInteger[] bigIntegerArr2 = f26974c;
    ...
    public static String a(int i10, int[] iArr) throws FormatException {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            bigIntegerAdd = bigIntegerAdd.add(f26974c[(i10 - i11) - 1].multiply(BigInteger.valueOf(iArr[i11])));
        }
    ...
    */
    public static int b(int[] r16, int[] r17, int r18, jh.g r19, int r20) {
        /*
            Method dump skipped, instruction units count: 270
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: wh.b.b(int[], int[], int, jh.g, int):int");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int c(int[] r8, int r9, jh.g r10) throws com.google.zxing.FormatException {
        /*
            r0 = 15
            int[] r0 = new int[r0]
            r1 = 0
        ...
        L3c:
            ...
            java.lang.Object r4 = r10.f13039b
        ...
        L4b:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: wh.b.c(int[], int, jh.g):int");
    }
    ...
    /*  JADX ERROR: UnsupportedOperationException in pass: RegionMakerVisitor
        ...
        */
    public static int d(int[] r11, int r12, jh.g r13) {
        /*
            r0 = 0
            r1 = r11[r0]
            int r1 = r1 - r12
        ...
        L6d:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: wh.b.d(int[], int, jh.g):int");
    }
}
