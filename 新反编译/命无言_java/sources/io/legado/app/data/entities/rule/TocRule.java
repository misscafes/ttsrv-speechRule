...
public final class TocRule implements Parcelable {
    ...
    private static final r jsonDeserializer = new a(6);
    ...
    public static final TocRule jsonDeserializer$lambda$0(s sVar, Type type, q qVar) {
        ...
        if (sVar instanceof u) {
            return (TocRule) g0.c().g(sVar, TocRule.class);
        }
        if (sVar instanceof v) {
            return (TocRule) g0.c().e(TocRule.class, sVar.p());
        }
        return null;
    }
    ...
    public String toString() {
        ...
        String str9 = this.updateTime;
        String str10 = this.nextTocUrl;
        StringBuilder sbI = n.i("TocRule(preUpdateJs=", str, ", chapterList=", str2, ", chapterName=");
        c.C(sbI, str3, ", chapterUrl=", str4, ", formatJs=");
        c.C(sbI, str5, ", isVolume=", str6, ", isVip=");
        c.C(sbI, str7, ", isPay=", str8, ", updateTime=");
        sbI.append(str9);
        sbI.append(", nextTocUrl=");
        sbI.append(str10);
        sbI.append(")");
        return sbI.toString();
    }
    ...
    public /* synthetic */ TocRule(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, int i10, e eVar) {
