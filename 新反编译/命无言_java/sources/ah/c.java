...
public abstract class c {
    ...
    public static final hi.a f396a;
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbY = u1.y("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbY.append(e(e10));
            throw new JsonIOException(sbY.toString(), e10);
        }
    }
}
