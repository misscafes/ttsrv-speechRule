    ...
    */
    ...
    public Iterator<Attribute> iterator() {
        return new Iterator<Attribute>() { // from class: org.jsoup.nodes.Attributes.1
            ...
            public boolean hasNext() {
                checkModified();
                while (this.f19192i < Attributes.this.size) {
                    Attributes attributes = Attributes.this;
                    if (!attributes.isInternalKey(attributes.keys[this.f19192i])) {
                        break;
                    }
                    this.f19192i++;
                }
                return this.f19192i < Attributes.this.size;
            }

            @Override // java.util.Iterator
            public void remove() {
                Attributes attributes = Attributes.this;
                int i10 = this.f19192i - 1;
                this.f19192i = i10;
