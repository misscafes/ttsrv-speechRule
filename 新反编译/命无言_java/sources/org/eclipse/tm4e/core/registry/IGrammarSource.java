...
public interface IGrammarSource {
    ...
    /* JADX INFO: renamed from: org.eclipse.tm4e.core.registry.IGrammarSource$-CC, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-05bfbbe9086a2edb9eee68032a6875ae8b29a17573f56b596f68c5a5f5b16892 */
    public abstract /* synthetic */ class CC {
        public static ContentType a(IGrammarSource iGrammarSource) {
        ...
        public static IGrammarSource c(final File file, final ContentType contentType, final Charset charset) {
        ...
        public static IGrammarSource d(InputStream inputStream, final String str, Charset charset) {
        ...
        public static IGrammarSource f(final Class cls, final String str, final ContentType contentType, final Charset charset) {
            if (contentType == null) {
                contentType = h(str);
            }
        ...
        public static IGrammarSource g(final ContentType contentType, final String str) {
