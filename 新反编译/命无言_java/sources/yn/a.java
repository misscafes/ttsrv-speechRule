...
public final /* synthetic */ class a implements lr.l {
    public final /* synthetic */ TxtTocRuleActivity A;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final /* synthetic */ int f28973i = 1;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final /* synthetic */ Uri f28974v;

    public /* synthetic */ a(Uri uri, TxtTocRuleActivity txtTocRuleActivity) {
        this.f28974v = uri;
        this.A = txtTocRuleActivity;
    }

    @Override // lr.l
    public final Object invoke(Object obj) {
        int i10 = this.f28973i;
        vq.q qVar = vq.q.f26327a;
        TxtTocRuleActivity txtTocRuleActivity = this.A;
        ...
        switch (i10) {
            case 0:
                ...
                j1.F0(txtTocRuleActivity, string);
                break;
            default:
                wl.d dVar = (wl.d) obj;
                ...
                autoCompleteTextView.setHint(txtTocRuleActivity.getString(R.string.path));
                ...
                dVar.g(new a(txtTocRuleActivity, uri));
                break;
        }
        return qVar;
    }

    public /* synthetic */ a(TxtTocRuleActivity txtTocRuleActivity, Uri uri) {
        this.A = txtTocRuleActivity;
        this.f28974v = uri;
    }
}
