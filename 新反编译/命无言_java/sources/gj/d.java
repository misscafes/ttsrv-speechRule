...
public final class d extends NativeJavaObject {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final c f9355i = new c(0);

    @Override // org.mozilla.javascript.NativeJavaObject, org.mozilla.javascript.Scriptable
    public final Object get(String str, Scriptable scriptable) {
        mr.i.e(str, "name");
        mr.i.e(scriptable, "start");
        if (str.length() > 3 && w.V(str, "set", false)) {
            String strSubstring = str.substring(3);
            mr.i.d(strSubstring, "substring(...)");
            if (strSubstring.length() > 0) {
                StringBuilder sb2 = new StringBuilder();
                String strValueOf = String.valueOf(strSubstring.charAt(0));
                mr.i.c(strValueOf, "null cannot be cast to non-null type java.lang.String");
