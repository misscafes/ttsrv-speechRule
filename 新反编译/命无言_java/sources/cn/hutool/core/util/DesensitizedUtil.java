...
public class DesensitizedUtil {
    ...
    /* JADX INFO: renamed from: cn.hutool.core.util.DesensitizedUtil$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-05bfbbe9086a2edb9eee68032a6875ae8b29a17573f56b596f68c5a5f5b16892 */
    ...
    public static String address(String str, int i10) {
        if (d.isBlank(str)) {
            return d.EMPTY;
        }
        int length = str.length();
        return d.hide(str, length - i10, length);
    }
    ...
    public static String bankCard(String str) {
        ...
        String strCleanBlank = d.cleanBlank(str);
        ...
        int i11 = (length - 4) - i10;
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) strCleanBlank, 0, 4);
        ...
        sb2.append(' ');
        sb2.append((CharSequence) strCleanBlank, length - i10, length);
        return sb2.toString();
    }

    public static String carLicense(String str) {
        return d.isBlank(str) ? d.EMPTY : str.length() == 7 ? d.hide(str, 3, 6) : str.length() == 8 ? d.hide(str, 3, 7) : str;
    }
    ...
    public static String email(String str) {
        ...
        int iIndexOf = d.indexOf(str, ScopeNames.CONTRIBUTOR_SEPARATOR);
        return iIndexOf <= 1 ? str : d.hide(str, 1, iIndexOf);
    }

    public static String firstMask(String str) {
        return d.isBlank(str) ? d.EMPTY : d.hide(str, 1, str.length());
    }

    public static String fixedPhone(String str) {
        return d.isBlank(str) ? d.EMPTY : d.hide(str, 4, str.length() - 2);
    }

    public static String idCardNum(String str, int i10, int i11) {
        return (!d.isBlank(str) && i10 + i11 <= str.length() && i10 >= 0 && i11 >= 0) ? d.hide(str, i10, str.length() - i11) : d.EMPTY;
    }

    public static String ipv4(String str) {
        return d.subBefore((CharSequence) str, '.', false) + ".*.*.*";
    }
    ...
    public static String mobilePhone(String str) {
        return d.isBlank(str) ? d.EMPTY : d.hide(str, 3, str.length() - 4);
    }

    public static String password(String str) {
        return d.isBlank(str) ? d.EMPTY : d.repeat('*', str.length());
    }
