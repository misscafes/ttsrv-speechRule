...
public class HexUtil {
    public static void appendHex(StringBuilder sb2, byte b10, boolean z4) {
        (z4 ? Base16Codec.CODEC_LOWER : Base16Codec.CODEC_UPPER).appendHex(sb2, b10);
    }
    ...
    public static char[] encodeHex(byte[] bArr, boolean z4) {
        return (z4 ? Base16Codec.CODEC_LOWER : Base16Codec.CODEC_UPPER).encode(bArr);
    }
    ...
    public static String encodeHexStr(byte[] bArr, boolean z4) {
