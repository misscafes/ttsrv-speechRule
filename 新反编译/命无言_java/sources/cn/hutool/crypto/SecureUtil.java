...
public class SecureUtil {
    ...
    public static byte[] decode(String str) {
        Pattern pattern = t.f17566a;
        return ReUtil.isMatch(l.f17553l, str) ? HexUtil.decodeHex(str) : Base64.decode(str);
    }
    ...
    public static String generateAlgorithm(AsymmetricAlgorithm asymmetricAlgorithm, DigestAlgorithm digestAlgorithm) {
        return d.format("{}with{}", digestAlgorithm == null ? "NONE" : digestAlgorithm.name(), asymmetricAlgorithm.getValue());
    }
    ...
    public static HMac hmac(HmacAlgorithm hmacAlgorithm, String str) {
        return hmac(hmacAlgorithm, d.isNotEmpty(str) ? d.utf8Bytes(str) : null);
    }

    public static HMac hmacMd5(String str) {
        return hmacMd5(d.isNotEmpty(str) ? d.utf8Bytes(str) : null);
    }

    public static HMac hmacSha1(String str) {
        return hmacSha1(d.isNotEmpty(str) ? d.utf8Bytes(str) : null);
    }

    public static HMac hmacSha256(String str) {
        return hmacSha256(d.isNotEmpty(str) ? d.utf8Bytes(str) : null);
    }
    ...
    public static SecretKey generateKey(String str, int i10) {
        return KeyUtil.generateKey(str, i10);
    }

    public static KeyPair generateKeyPair(String str, int i10) {
        return KeyUtil.generateKeyPair(str, i10);
    }
    ...
    public static String signParams(SymmetricCrypto symmetricCrypto, Map<?, ?> map, String str, String str2, boolean z4, String... strArr) {
        return SignUtil.signParams(symmetricCrypto, map, str, str2, z4, strArr);
    }
    ...
    public static KeyPair generateKeyPair(String str, int i10, byte[] bArr) {
        return KeyUtil.generateKeyPair(str, i10, bArr);
    }
    ...
    public static String signParams(DigestAlgorithm digestAlgorithm, Map<?, ?> map, String str, String str2, boolean z4, String... strArr) {
        return SignUtil.signParams(digestAlgorithm, map, str, str2, z4, strArr);
    }
