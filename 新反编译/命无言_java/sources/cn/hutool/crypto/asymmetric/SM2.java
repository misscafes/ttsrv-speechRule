...
public class SM2 extends AbstractAsymmetricCrypto<SM2> {
    ...
    private CipherParameters getCipherParameters(KeyType keyType) {
        ...
        if (i10 == 1) {
            e.B(this.publicKeyParams, "PublicKey must be not null !", new Object[0]);
            return this.publicKeyParams;
        }
        if (i10 != 2) {
            return null;
        }
        e.B(this.privateKeyParams, "PrivateKey must be not null !", new Object[0]);
        return this.privateKeyParams;
    }

    private SM2Engine getEngine() {
        if (this.engine == null) {
            e.B(this.digest, "digest must be not null !", new Object[0]);
    ...
    public byte[] getQ(boolean z4) {
        return this.publicKeyParams.getQ().getEncoded(z4);
    }
    ...
    public byte[] sign(byte[] bArr, byte[] bArr2) {
        ...
        try {
            try {
                ...
                throw new cn.hutool.crypto.CryptoException((Throwable) e10);
            }
        } catch (Throwable th2) {
            this.lock.unlock();
            throw th2;
    ...
    public byte[] decrypt(byte[] bArr, CipherParameters cipherParameters) {
        this.lock.lock();
    ...
    public byte[] encrypt(byte[] bArr, CipherParameters cipherParameters) {
        this.lock.lock();
        SM2Engine engine = getEngine();
        try {
            try {
