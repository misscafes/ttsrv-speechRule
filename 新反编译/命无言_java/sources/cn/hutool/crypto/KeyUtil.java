...
public class KeyUtil {
    ...
    public static SecretKey generateDESKey(String str, byte[] bArr) {
        if (d.isBlank(str) || !str.startsWith("DES")) {
    ...
    public static SecretKey generatePBEKey(String str, char[] cArr) {
        if (d.isBlank(str) || !str.startsWith("PBE")) {
    ...
    public static String getAlgorithmAfterWith(String str) {
        e.B(str, "algorithm must be not null !", new Object[0]);
        if (d.startWithIgnoreCase(str, "ECIESWith")) {
            return "EC";
        }
        int iLastIndexOfIgnoreCase = d.lastIndexOfIgnoreCase(str, "with");
        if (iLastIndexOfIgnoreCase > 0) {
            str = d.subSuf(str, iLastIndexOfIgnoreCase + 4);
        }
    ...
    public static String getMainAlgorithm(String str) throws Throwable {
    ...
    public static KeyStore readKeyStore(String str, File file, char[] cArr) throws Throwable {
        ...
        try {
            ...
            try {
                KeyStore keyStore = readKeyStore(str, bufferedInputStreamN, cArr);
    ...
    public static SecretKey generateKey(String str, int i10) {
        return generateKey(str, i10, null);
    }
    ...
    public static SecretKey generateKey(String str, int i10, SecureRandom secureRandom) throws Throwable {
        String mainAlgorithm = getMainAlgorithm(str);
        KeyGenerator keyGenerator = getKeyGenerator(mainAlgorithm);
        if (i10 <= 0 && SymmetricAlgorithm.AES.getValue().equals(mainAlgorithm)) {
            i10 = 128;
        }
        if (i10 > 0) {
    ...
    public static KeyPair generateKeyPair(String str, int i10) {
        return generateKeyPair(str, i10, (byte[]) null);
    }
    ...
    public static KeyPair generateKeyPair(String str, int i10, byte[] bArr) {
        return "SM2".equalsIgnoreCase(str) ? generateKeyPair(str, i10, bArr, new ECGenParameterSpec("sm2p256v1")) : generateKeyPair(str, i10, bArr, (AlgorithmParameterSpec[]) null);
    }
    ...
    public static SecretKey generateKey(String str, byte[] bArr) throws Throwable {
        e.z(str, "Algorithm is blank!", new Object[0]);
    ...
    public static KeyPair generateKeyPair(String str, int i10, byte[] bArr, AlgorithmParameterSpec... algorithmParameterSpecArr) {
        return generateKeyPair(str, i10, RandomUtil.createSecureRandom(bArr), algorithmParameterSpecArr);
    }

    public static KeyPair generateKeyPair(String str, int i10, SecureRandom secureRandom, AlgorithmParameterSpec... algorithmParameterSpecArr) {
        ...
        if (i10 > 0) {
            if ("EC".equalsIgnoreCase(algorithmAfterWith) && i10 > 256) {
                i10 = 256;
            }
            if (secureRandom != null) {
