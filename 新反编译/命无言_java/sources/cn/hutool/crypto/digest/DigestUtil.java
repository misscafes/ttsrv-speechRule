...
public class DigestUtil {
    ...
    public static byte[] md5(String str) {
        return md5(str, CharsetUtil.UTF_8);
    }
    ...
    public static byte[] sha1(String str) {
        return sha1(str, CharsetUtil.UTF_8);
    }

    public static String sha1Hex(String str) {
        return sha1Hex(str, CharsetUtil.UTF_8);
    }

    public static byte[] sha256(String str) {
        return sha256(str, CharsetUtil.UTF_8);
    }

    public static String sha256Hex(String str) {
        return sha256Hex(str, CharsetUtil.UTF_8);
    }

    public static byte[] sha512(String str) {
        return sha512(str, CharsetUtil.UTF_8);
    }

    public static String sha512Hex(String str) {
        return sha512Hex(str, CharsetUtil.UTF_8);
    }
    ...
    public static String md5Hex(String str) {
        return md5Hex(str, CharsetUtil.UTF_8);
    }
