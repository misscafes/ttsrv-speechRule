...
public final class l0 implements z1, p0, j0.k {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final b1 f8139i;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public static final c f8138v = new c("camerax.core.imageAnalysis.backpressureStrategy", d0.c0.class, null);
    public static final c A = new c("camerax.core.imageAnalysis.imageQueueDepth", Integer.TYPE, null);
    public static final c X = new c("camerax.core.imageAnalysis.imageReaderProxyProvider", d0.u0.class, null);
    public static final c Y = new c("camerax.core.imageAnalysis.outputImageFormat", d0.e0.class, null);
    public static final c Z = new c("camerax.core.imageAnalysis.onePixelShiftEnabled", Boolean.class, null);

    /* JADX INFO: renamed from: i0, reason: collision with root package name */
    public static final c f8137i0 = new c("camerax.core.imageAnalysis.outputImageRotationEnabled", Boolean.class, null);
    ...
    @Override // f0.f0
    public final /* synthetic */ Object C(c cVar, Object obj) {
    ...
    @Override // f0.f0
    public final /* synthetic */ boolean e(c cVar) {
