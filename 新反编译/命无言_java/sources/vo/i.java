...
public final class i extends b {
    ...
    public final void B(yk.c cVar, o7.a aVar) {
        mr.i.e((t4) aVar, "binding");
        cVar.f23179a.setOnClickListener(new rm.u(this, 17, cVar));
    }
    ...
    public final void w(yk.c cVar, o7.a aVar, Object obj, List list) {
        ...
        mr.i.e(t4Var, "binding");
        ImageView imageView = t4Var.f7543b;
        TextView textView = t4Var.f7545d;
        ...
        t4Var.f7544c.setText(rssArticle.getPubDate());
    ...
    public final o7.a z(ViewGroup viewGroup) {
        View viewInflate = this.f28925e.inflate(R.layout.item_rss_article_2, viewGroup, false);
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    return new t4((ConstraintLayout) viewInflate, imageView, textView, textView2);
                }
            }
        }
